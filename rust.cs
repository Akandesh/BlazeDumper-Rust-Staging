...
namespace blazedumper {
    ...
    public static class BasePlayer
    {
        ...
        public const Int32 __menuOption_SaltWater = 0x590; // Option
        public const Int32 clanId = 0x610; // long
        public const Int32 playerModel = 0x618; // PlayerModel
        public const Int32 Frozen = 0x620; // bool
        public const Int32 LookLocked = 0x621; // bool
        public const Int32 voiceRecorder = 0x628; // PlayerVoiceRecorder
        public const Int32 voiceSpeaker = 0x630; // PlayerVoiceSpeaker
        public const Int32 input = 0x638; // PlayerInput
        public const Int32 movement = 0x640; // BaseMovement
        public const Int32 collision = 0x648; // BaseCollision
        public const Int32 bagCount = 0x650; // int
        public const Int32 shelterCount = 0x654; // int
        public const Int32 modelInitUnderwear = 0x658; // uint
        public const Int32 _lookingAt = 0x660; // GameObject
        public const Int32 _lookingAtEntity = 0x668; // BaseEntity
        public const Int32 _lookingAtCollider = 0x670; // Collider
        public const Int32 lookingAtPoint = 0x678; // Vector3
        public const Int32 wakeTime = 0x684; // float
        public const Int32 needsClothesRebuild = 0x688; // bool
        public const Int32 wasSleeping = 0x689; // bool
        public const Int32 wokeUpBefore = 0x68A; // bool
        public const Int32 wasDead = 0x68B; // bool
        public const Int32 HasMountedClothing = 0x68C; // bool
        public const Int32 HasWearableClothing = 0x68D; // bool
        public const Int32 lastClothesHash = 0x690; // uint
        public const Int32 lastOpenSoundPlay = 0x694; // TimeSince
        public const Int32 currentViewMode = 0x698; // BasePlayer.CameraMode
        public const Int32 selectedViewMode = 0x69C; // BasePlayer.CameraMode
        public const Int32 lastRevivePoint = 0x6A0; // Vector3
        public const Int32 lastReviveDirection = 0x6AC; // Vector3
        public const Int32 IsWearingDiveGoggles = 0x6B8; // bool
        public const Int32 GestureViewModel = 0x6C0; // ViewModel
        public const Int32 currentClientRespawnInformation = 0x6C8; // RespawnInformation
        public const Int32 respawnOptionsTimestamp = 0x6D0; // float
        public const Int32 lastParachuteRequest = 0x6D4; // TimeSince
        public const Int32 timeSinceUpdatedLookingAt = 0x6D8; // RealTimeSince
        public const Int32 nextTopologyTestTime = 0x6DC; // float
        public const Int32 usePressTime = 0x6E0; // float
        public const Int32 useHeldTime = 0x6E4; // float
        public const Int32 lookingAtTest = 0x6E8; // HitTest
        public const Int32 cachedWaterDrinkingPoint = 0x6F0; // Vector3
        public const Int32 hasRequestedServerEmoji = 0x6FC; // bool
        public const Int32 gestureList = 0x710; // GestureCollection
        public const Int32 gestureFinishedTime = 0x718; // TimeUntil
        public const Int32 blockHeldInputTimer = 0x71C; // TimeSince
        public const Int32 currentGesture = 0x720; // GestureConfig
        public const Int32 disabledHeldEntity = 0x728; // HeldEntity
        public const Int32 nextGestureMenuOpenTime = 0x730; // float
        public const Int32 lastGestureCancel = 0x734; // TimeSince
        public const Int32 client_lastHelloTime = 0x738; // float
        public const Int32 currentTeam = 0x740; // ulong
        public const Int32 clientTeam = 0x748; // PlayerTeam
        public const Int32 lastReceivedTeamTime = 0x750; // float
        public const Int32 lastPresenceTeamId = 0x758; // ulong
        public const Int32 lastPresenceTeamSize = 0x760; // int
        public const Int32 playerGroupKey = 0x768; // string
        public const Int32 playerGroupSizeKey = 0x770; // string
        public const Int32 clActiveItem = 0x778; // ItemId
        public const Int32 ClientCurrentMapNotes = 0x780; // List<MapNote>
        public const Int32 ClientCurrentDeathNote = 0x788; // MapNote
        public const Int32 keepOpenMapInterface = 0x790; // bool
        public const Int32 missions = 0x798; // List<BaseMission.MissionInstance>
        public const Int32 _activeMission = 0x7A0; // int
        public const Int32 modelState = 0x7A8; // ModelState
        public const Int32 mounted = 0x7B0; // EntityRef
        public const Int32 nextSeatSwapTime = 0x7C0; // float
        public const Int32 mountInputHeldDuringDismount = 0x7C4; // bool
        public const Int32 PetEntity = 0x7C8; // BaseEntity
        public const Int32 lastPetCommandIssuedTime = 0x7D0; // float
        public const Int32 PetPrefabID = 0x7D4; // uint
        public const Int32 PetID = 0x7D8; // NetworkableId
        public const Int32 ClientCurrentPings = 0x7E0; // List<MapNote>
        public const Int32 tapInProcess = 0x7E8; // bool
        public const Int32 lastPingTap = 0x7EC; // TimeSince
        public const Int32 cachedBuildingPrivilegeTime = 0x7F0; // float
        public const Int32 cachedBuildingPrivilege = 0x7F8; // BuildingPrivlidge
        public const Int32 cachedVehicleBuildingBlockedTime = 0x800; // float
        public const Int32 cachedVehicleBuildingBlocked = 0x804; // bool
        public const Int32 cachedEntityBuildingBlockedTime = 0x808; // float
        public const Int32 cachedEntityBuildingBlocked = 0x80C; // bool
        public const Int32 cachedPrivilegeFromOther = 0x810; // BaseEntity
        public const Int32 cachedPrivilegeFromOtherTime = 0x818; // float
        public const Int32 maxProjectileID = 0x81C; // int
        public const Int32 lastSpectateCameraUpdate = 0x820; // TimeSince
        public const Int32 lastUpdateTime = 0x824; // float
        public const Int32 cachedThreatLevel = 0x828; // float
        public const Int32 serverTickRate = 0x82C; // int
        public const Int32 clientTickRate = 0x830; // int
        public const Int32 serverTickInterval = 0x834; // float
        public const Int32 clientTickInterval = 0x838; // float
        public const Int32 lastSentTickTime = 0x83C; // float
        public const Int32 lastTickStopwatch = 0x840; // Stopwatch
        public const Int32 lastSentTick = 0x848; // PlayerTick
        public const Int32 CurrentTutorialAllowance = 0x850; // BasePlayer.TutorialItemAllowance
        public const Int32 startTutorialCooldown = 0x854; // float
        public const Int32 nextVisThink = 0x858; // float
        public const Int32 lastTimeSeen = 0x85C; // float
        public const Int32 debugPrevVisible = 0x860; // bool
        public const Int32 fallDamageEffect = 0x868; // GameObjectRef
        public const Int32 drownEffect = 0x870; // GameObjectRef
        public const Int32 playerFlags = 0x878; // BasePlayer.PlayerFlags
        public const Int32 eyes = 0x880; // PlayerEyes
        public const Int32 inventory = 0x888; // PlayerInventory
        public const Int32 blueprints = 0x890; // PlayerBlueprints
        public const Int32 metabolism = 0x898; // PlayerMetabolism
        public const Int32 modifiers = 0x8A0; // PlayerModifiers
        public const Int32 playerCollider = 0x8A8; // CapsuleCollider
        public const Int32 Belt = 0x8B0; // PlayerBelt
        public const Int32 playerRigidbody = 0x8B8; // Rigidbody
        public const Int32 userID = 0x8C0; // ulong
        public const Int32 UserIDString = 0x8C8; // string
        public const Int32 gamemodeteam = 0x8D0; // int
        public const Int32 reputation = 0x8D4; // int
        public const Int32 _displayName = 0x8D8; // string
        public const Int32 _lastSetName = 0x8E0; // string
        public const Int32 playerColliderStanding = 0x8E8; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderDucked = 0x8FC; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderCrawling = 0x910; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderLyingDown = 0x924; // BasePlayer.CapsuleColliderInfo
        public const Int32 cachedProtection = 0x938; // ProtectionProperties
        public const Int32 lastHeadshotSoundTime = 0x940; // float
        public const Int32 nextColliderRefreshTime = 0x944; // float
        public const Int32 weaponMoveSpeedScale = 0x948; // float
        public const Int32 clothingBlocksAiming = 0x94C; // bool
        public const Int32 clothingMoveSpeedReduction = 0x950; // float
        public const Int32 clothingWaterSpeedBonus = 0x954; // float
        public const Int32 clothingAccuracyBonus = 0x958; // float
        public const Int32 equippingBlocked = 0x95C; // bool
        public const Int32 eggVision = 0x960; // float
        public const Int32 activeTelephone = 0x968; // PhoneController
        public const Int32 designingAIEntity = 0x970; // BaseEntity
    }
    ...
    {
        public const Int32 __menuOption_Menu_MaxAuth = 0x4B0; // Option
        public const Int32 __menuOption_Menu_RotateVM = 0x530; // Option
        public const Int32 __menuOption_MenuAuthorize = 0x5B0; // Option
        public const Int32 __menuOption_MenuClearList = 0x630; // Option
        public const Int32 __menuOption_MenuDeauthorize = 0x6B0; // Option
        public const Int32 allowedConstructionItems = 0x730; // List<ItemDefinition>
        public const Int32 cachedProtectedMinutes = 0x738; // float
        public const Int32 cachedUpkeepPeriodMinutes = 0x73C; // float
        public const Int32 cachedUpkeepCostFraction = 0x740; // float
        public const Int32 clientAuthed = 0x744; // bool
        public const Int32 clientAnyAuthed = 0x745; // bool
        public const Int32 lastProtectedMinuteUpdate = 0x748; // DateTime
    }
