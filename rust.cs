...
namespace blazedumper {
    ...
    public static class BasePlayer
    {
        ...
        public const Int32 __menuOption_InviteToTeam = 0x320; // Option
        public const Int32 __menuOption_Menu_AssistPlayer = 0x388; // Option
        public const Int32 __menuOption_Menu_LootPlayer = 0x3F0; // Option
        public const Int32 __menuOption_Promote = 0x458; // Option
        public const Int32 __menuOption_SaltWater = 0x4C0; // Option
        public const Int32 playerModel = 0x528; // PlayerModel
        public const Int32 Frozen = 0x530; // bool
        public const Int32 voiceRecorder = 0x538; // PlayerVoiceRecorder
        public const Int32 voiceSpeaker = 0x540; // PlayerVoiceSpeaker
        public const Int32 input = 0x548; // PlayerInput
        public const Int32 movement = 0x550; // BaseMovement
        public const Int32 collision = 0x558; // BaseCollision
        public const Int32 bagCount = 0x560; // int
        public const Int32 _lookingAt = 0x568; // GameObject
        public const Int32 _lookingAtEntity = 0x570; // BaseEntity
        public const Int32 _lookingAtCollider = 0x578; // Collider
        public const Int32 lookingAtPoint = 0x580; // Vector3
        public const Int32 wakeTime = 0x58C; // float
        public const Int32 needsClothesRebuild = 0x590; // bool
        public const Int32 wasSleeping = 0x591; // bool
        public const Int32 wokeUpBefore = 0x592; // bool
        public const Int32 wasDead = 0x593; // bool
        public const Int32 lastClothesHash = 0x594; // uint
        public const Int32 lastOpenSoundPlay = 0x598; // TimeSince
        public const Int32 currentViewMode = 0x59C; // BasePlayer.CameraMode
        public const Int32 selectedViewMode = 0x5A0; // BasePlayer.CameraMode
        public const Int32 lastRevivePoint = 0x5A4; // Vector3
        public const Int32 lastReviveDirection = 0x5B0; // Vector3
        public const Int32 IsWearingDiveGoggles = 0x5BC; // bool
        public const Int32 GestureViewModel = 0x5C0; // ViewModel
        public const Int32 currentClientRespawnInformation = 0x5C8; // RespawnInformation
        public const Int32 respawnOptionsTimestamp = 0x5D0; // float
        public const Int32 timeSinceUpdatedLookingAt = 0x5D4; // RealTimeSince
        public const Int32 nextTopologyTestTime = 0x5D8; // float
        public const Int32 usePressTime = 0x5DC; // float
        public const Int32 useHeldTime = 0x5E0; // float
        public const Int32 lookingAtTest = 0x5E8; // HitTest
        public const Int32 cachedWaterDrinkingPoint = 0x5F0; // Vector3
        public const Int32 gestureList = 0x600; // GestureCollection
        public const Int32 gestureFinishedTime = 0x608; // TimeUntil
        public const Int32 blockHeldInputTimer = 0x60C; // TimeSince
        public const Int32 currentGesture = 0x610; // GestureConfig
        public const Int32 disabledHeldEntity = 0x618; // HeldEntity
        public const Int32 nextGestureMenuOpenTime = 0x620; // float
        public const Int32 lastGestureCancel = 0x624; // TimeSince
        public const Int32 client_lastHelloTime = 0x628; // float
        public const Int32 currentTeam = 0x630; // ulong
        public const Int32 clientTeam = 0x638; // PlayerTeam
        public const Int32 lastReceivedTeamTime = 0x640; // float
        public const Int32 lastPresenceTeamId = 0x648; // ulong
        public const Int32 lastPresenceTeamSize = 0x650; // int
        public const Int32 playerGroupKey = 0x658; // string
        public const Int32 playerGroupSizeKey = 0x660; // string
        public const Int32 clActiveItem = 0x668; // ItemId
        public const Int32 ClientCurrentMapNotes = 0x670; // List<MapNote>
        public const Int32 ClientCurrentDeathNote = 0x678; // MapNote
        public const Int32 keepOpenMapInterface = 0x680; // bool
        public const Int32 missions = 0x688; // List<BaseMission.MissionInstance>
        public const Int32 _activeMission = 0x690; // int
        public const Int32 modelState = 0x698; // ModelState
        public const Int32 mounted = 0x6A0; // EntityRef
        public const Int32 nextSeatSwapTime = 0x6B0; // float
        public const Int32 PetEntity = 0x6B8; // BaseEntity
        public const Int32 lastPetCommandIssuedTime = 0x6C0; // float
        public const Int32 PetPrefabID = 0x6C4; // uint
        public const Int32 PetID = 0x6C8; // NetworkableId
        public const Int32 ClientCurrentPings = 0x6D0; // List<MapNote>
        public const Int32 tapInProcess = 0x6D8; // bool
        public const Int32 lastPingTap = 0x6DC; // TimeSince
        public const Int32 cachedBuildingPrivilegeTime = 0x6E0; // float
        public const Int32 cachedBuildingPrivilege = 0x6E8; // BuildingPrivlidge
        public const Int32 cachedVehicleBuildingBlockedTime = 0x6F0; // float
        public const Int32 cachedVehicleBuildingBlocked = 0x6F4; // bool
        public const Int32 maxProjectileID = 0x6F8; // int
        public const Int32 lastUpdateTime = 0x6FC; // float
        public const Int32 cachedThreatLevel = 0x700; // float
        public const Int32 serverTickRate = 0x704; // int
        public const Int32 clientTickRate = 0x708; // int
        public const Int32 serverTickInterval = 0x70C; // float
        public const Int32 clientTickInterval = 0x710; // float
        public const Int32 lastSentTickTime = 0x714; // float
        public const Int32 lastTickStopwatch = 0x718; // Stopwatch
        public const Int32 lastSentTick = 0x720; // PlayerTick
        public const Int32 nextVisThink = 0x728; // float
        public const Int32 lastTimeSeen = 0x72C; // float
        public const Int32 debugPrevVisible = 0x730; // bool
        public const Int32 fallDamageEffect = 0x738; // GameObjectRef
        public const Int32 drownEffect = 0x740; // GameObjectRef
        public const Int32 playerFlags = 0x748; // BasePlayer.PlayerFlags
        public const Int32 eyes = 0x750; // PlayerEyes
        public const Int32 inventory = 0x758; // PlayerInventory
        public const Int32 blueprints = 0x760; // PlayerBlueprints
        public const Int32 metabolism = 0x768; // PlayerMetabolism
        public const Int32 modifiers = 0x770; // PlayerModifiers
        public const Int32 playerCollider = 0x778; // CapsuleCollider
        public const Int32 Belt = 0x780; // PlayerBelt
        public const Int32 playerRigidbody = 0x788; // Rigidbody
        public const Int32 userID = 0x790; // ulong
        public const Int32 UserIDString = 0x798; // string
        public const Int32 gamemodeteam = 0x7A0; // int
        public const Int32 reputation = 0x7A4; // int
        public const Int32 _displayName = 0x7A8; // string
        public const Int32 _lastSetName = 0x7B0; // string
        public const Int32 playerColliderStanding = 0x7B8; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderDucked = 0x7CC; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderCrawling = 0x7E0; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderLyingDown = 0x7F4; // BasePlayer.CapsuleColliderInfo
        public const Int32 cachedProtection = 0x808; // ProtectionProperties
        public const Int32 lastHeadshotSoundTime = 0x810; // float
        public const Int32 nextColliderRefreshTime = 0x814; // float
        public const Int32 clothingBlocksAiming = 0x818; // bool
        public const Int32 clothingMoveSpeedReduction = 0x81C; // float
        public const Int32 clothingWaterSpeedBonus = 0x820; // float
        public const Int32 clothingAccuracyBonus = 0x824; // float
        public const Int32 equippingBlocked = 0x828; // bool
        public const Int32 eggVision = 0x82C; // float
        public const Int32 activeTelephone = 0x830; // PhoneController
        public const Int32 designingAIEntity = 0x838; // BaseEntity
    }
