...
namespace blazedumper {
    ...
    public static class BasePlayer
    {
        ...
        public const Int32 shelterCount = 0x6B4; // int
        public const Int32 modelInitUnderwear = 0x6B8; // uint
        public const Int32 _lookingAt = 0x6C0; // GameObject
        public const Int32 _lookingAtEntity = 0x6C8; // BaseEntity
        public const Int32 _lookingAtCollider = 0x6D0; // Collider
        public const Int32 lookingAtPoint = 0x6D8; // Vector3
        public const Int32 wakeTime = 0x6E4; // float
        public const Int32 needsClothesRebuild = 0x6E8; // bool
        public const Int32 wasSleeping = 0x6E9; // bool
        public const Int32 wokeUpBefore = 0x6EA; // bool
        public const Int32 wasDead = 0x6EB; // bool
        public const Int32 HasMountedClothing = 0x6EC; // bool
        public const Int32 lastClothesHash = 0x6F0; // uint
        public const Int32 lastOpenSoundPlay = 0x6F4; // TimeSince
        public const Int32 currentViewMode = 0x6F8; // BasePlayer.CameraMode
        public const Int32 selectedViewMode = 0x6FC; // BasePlayer.CameraMode
        public const Int32 lastRevivePoint = 0x700; // Vector3
        public const Int32 lastReviveDirection = 0x70C; // Vector3
        public const Int32 IsWearingDiveGoggles = 0x718; // bool
        public const Int32 GestureViewModel = 0x720; // ViewModel
        public const Int32 currentClientRespawnInformation = 0x728; // RespawnInformation
        public const Int32 respawnOptionsTimestamp = 0x730; // float
        public const Int32 lastParachuteRequest = 0x734; // TimeSince
        public const Int32 timeSinceUpdatedLookingAt = 0x738; // RealTimeSince
        public const Int32 nextTopologyTestTime = 0x73C; // float
        public const Int32 usePressTime = 0x740; // float
        public const Int32 useHeldTime = 0x744; // float
        public const Int32 lookingAtTest = 0x748; // HitTest
        public const Int32 cachedWaterDrinkingPoint = 0x750; // Vector3
        public const Int32 hasRequestedServerEmoji = 0x75C; // bool
        public const Int32 gestureList = 0x770; // GestureCollection
        public const Int32 gestureFinishedTime = 0x778; // TimeUntil
        public const Int32 blockHeldInputTimer = 0x77C; // TimeSince
        public const Int32 currentGesture = 0x780; // GestureConfig
        public const Int32 disabledHeldEntity = 0x788; // HeldEntity
        public const Int32 nextGestureMenuOpenTime = 0x790; // float
        public const Int32 lastGestureCancel = 0x794; // TimeSince
        public const Int32 client_lastHelloTime = 0x798; // float
        public const Int32 currentTeam = 0x7A0; // ulong
        public const Int32 clientTeam = 0x7A8; // PlayerTeam
        public const Int32 lastReceivedTeamTime = 0x7B0; // float
        public const Int32 lastPresenceTeamId = 0x7B8; // ulong
        public const Int32 lastPresenceTeamSize = 0x7C0; // int
        public const Int32 playerGroupKey = 0x7C8; // string
        public const Int32 playerGroupSizeKey = 0x7D0; // string
        public const Int32 clActiveItem = 0x7D8; // ItemId
        public const Int32 ClientCurrentMapNotes = 0x7E0; // List<MapNote>
        public const Int32 ClientCurrentDeathNote = 0x7E8; // MapNote
        public const Int32 keepOpenMapInterface = 0x7F0; // bool
        public const Int32 missions = 0x7F8; // List<BaseMission.MissionInstance>
        public const Int32 _activeMission = 0x800; // int
        public const Int32 modelState = 0x808; // ModelState
        public const Int32 mounted = 0x810; // EntityRef
        public const Int32 nextSeatSwapTime = 0x820; // float
        public const Int32 mountInputHeldDuringDismount = 0x824; // bool
        public const Int32 PetEntity = 0x828; // BaseEntity
        public const Int32 lastPetCommandIssuedTime = 0x830; // float
        public const Int32 PetPrefabID = 0x834; // uint
        public const Int32 PetID = 0x838; // NetworkableId
        public const Int32 ClientCurrentPings = 0x840; // List<MapNote>
        public const Int32 tapInProcess = 0x848; // bool
        public const Int32 lastPingTap = 0x84C; // TimeSince
        public const Int32 cachedBuildingPrivilegeTime = 0x850; // float
        public const Int32 cachedBuildingPrivilege = 0x858; // BuildingPrivlidge
        public const Int32 cachedVehicleBuildingBlockedTime = 0x860; // float
        public const Int32 cachedVehicleBuildingBlocked = 0x864; // bool
        public const Int32 cachedEntityBuildingBlockedTime = 0x868; // float
        public const Int32 cachedEntityBuildingBlocked = 0x86C; // bool
        public const Int32 cachedPrivilegeFromOther = 0x870; // BaseEntity
        public const Int32 cachedPrivilegeFromOtherTime = 0x878; // float
        public const Int32 maxProjectileID = 0x87C; // int
        public const Int32 lastSpectateCameraUpdate = 0x880; // TimeSince
        public const Int32 lastUpdateTime = 0x884; // float
        public const Int32 cachedThreatLevel = 0x888; // float
        public const Int32 serverTickRate = 0x88C; // int
        public const Int32 clientTickRate = 0x890; // int
        public const Int32 serverTickInterval = 0x894; // float
        public const Int32 clientTickInterval = 0x898; // float
        public const Int32 lastSentTickTime = 0x89C; // float
        public const Int32 lastTickStopwatch = 0x8A0; // Stopwatch
        public const Int32 lastSentTick = 0x8A8; // PlayerTick
        public const Int32 nextVisThink = 0x8B0; // float
        public const Int32 lastTimeSeen = 0x8B4; // float
        public const Int32 debugPrevVisible = 0x8B8; // bool
        public const Int32 fallDamageEffect = 0x8C0; // GameObjectRef
        public const Int32 drownEffect = 0x8C8; // GameObjectRef
        public const Int32 playerFlags = 0x8D0; // BasePlayer.PlayerFlags
        public const Int32 eyes = 0x8D8; // PlayerEyes
        public const Int32 inventory = 0x8E0; // PlayerInventory
        public const Int32 blueprints = 0x8E8; // PlayerBlueprints
        public const Int32 metabolism = 0x8F0; // PlayerMetabolism
        public const Int32 modifiers = 0x8F8; // PlayerModifiers
        public const Int32 playerCollider = 0x900; // CapsuleCollider
        public const Int32 Belt = 0x908; // PlayerBelt
        public const Int32 playerRigidbody = 0x910; // Rigidbody
        public const Int32 userID = 0x918; // ulong
        public const Int32 UserIDString = 0x920; // string
        public const Int32 gamemodeteam = 0x928; // int
        public const Int32 reputation = 0x92C; // int
        public const Int32 _displayName = 0x930; // string
        public const Int32 _lastSetName = 0x938; // string
        public const Int32 playerColliderStanding = 0x940; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderDucked = 0x954; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderCrawling = 0x968; // BasePlayer.CapsuleColliderInfo
        public const Int32 playerColliderLyingDown = 0x97C; // BasePlayer.CapsuleColliderInfo
        public const Int32 cachedProtection = 0x990; // ProtectionProperties
        public const Int32 lastHeadshotSoundTime = 0x998; // float
        public const Int32 nextColliderRefreshTime = 0x99C; // float
        public const Int32 clothingBlocksAiming = 0x9A0; // bool
        public const Int32 clothingMoveSpeedReduction = 0x9A4; // float
        public const Int32 clothingWaterSpeedBonus = 0x9A8; // float
        public const Int32 clothingAccuracyBonus = 0x9AC; // float
        public const Int32 equippingBlocked = 0x9B0; // bool
        public const Int32 eggVision = 0x9B4; // float
        public const Int32 activeTelephone = 0x9B8; // PhoneController
        public const Int32 designingAIEntity = 0x9C0; // BaseEntity
    }
