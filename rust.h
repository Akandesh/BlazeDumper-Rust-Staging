...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F609C8;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FAFC48;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2FC1250;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2F9F388;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F60C38;
    namespace BasePlayer {
        constexpr ::std::ptrdiff_t __menuOption_Climb = 0x258; // Option
        constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2C8; // Option
        constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x338; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x3A8; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x418; // Option
        constexpr ::std::ptrdiff_t __menuOption_Promote = 0x488; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x4F8; // Option
        constexpr ::std::ptrdiff_t playerModel = 0x568; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x570; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x578; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x580; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x588; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x590; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x598; // BaseCollision
        constexpr ::std::ptrdiff_t _lookingAt = 0x5A0; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x5A8; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x5B0; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x5B8; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x5C4; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x5C8; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x5C9; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x5CA; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x5CB; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x5CC; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x5D0; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x5D4; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x5D8; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x5DC; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x5E8; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x5F4; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x5F8; // ViewModel
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x600; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x604; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x608; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x60C; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x610; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x618; // Vector3
        constexpr ::std::ptrdiff_t gestureList = 0x628; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x630; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x634; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x638; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x640; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x648; // float
        constexpr ::std::ptrdiff_t lastGestureCancel = 0x64C; // TimeSince
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x650; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x658; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x660; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x668; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x670; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x678; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x680; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x688; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x690; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x698; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x6A0; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x6A8; // bool
        constexpr ::std::ptrdiff_t missions = 0x6B0; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x6B8; // int
        constexpr ::std::ptrdiff_t modelState = 0x6C0; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x6C8; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x6D8; // float
        constexpr ::std::ptrdiff_t PetEntity = 0x6E0; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x6E8; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x6EC; // uint
        constexpr ::std::ptrdiff_t PetID = 0x6F0; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x6F8; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x700; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x704; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x708; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x710; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t maxProjectileID = 0x718; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x71C; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x720; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x724; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x728; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x72C; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x730; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x734; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x738; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x740; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x748; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x74C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x750; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x758; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x760; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x768; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x770; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x778; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x780; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x788; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x790; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x798; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x7A0; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x7A8; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x7B0; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x7B8; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x7C0; // int
        constexpr ::std::ptrdiff_t reputation = 0x7C4; // int
        constexpr ::std::ptrdiff_t _displayName = 0x7C8; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x7D0; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x7D8; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x7EC; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x800; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x814; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x828; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x830; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x834; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x838; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x83C; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x840; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x844; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x848; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x84C; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x850; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x858; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        constexpr ::std::ptrdiff_t skeletonProperties = 0x1D8; // SkeletonProperties
        constexpr ::std::ptrdiff_t baseProtection = 0x1E0; // ProtectionProperties
        constexpr ::std::ptrdiff_t startHealth = 0x1E8; // float
        constexpr ::std::ptrdiff_t pickup = 0x1F0; // BaseCombatEntity.Pickup
        constexpr ::std::ptrdiff_t repair = 0x210; // BaseCombatEntity.Repair
        constexpr ::std::ptrdiff_t ShowHealthInfo = 0x238; // bool
        constexpr ::std::ptrdiff_t lifestate = 0x23C; // BaseCombatEntity.LifeState
        constexpr ::std::ptrdiff_t sendsHitNotification = 0x240; // bool
        constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x241; // bool
        constexpr ::std::ptrdiff_t markAttackerHostile = 0x242; // bool
        constexpr ::std::ptrdiff_t _health = 0x244; // float
        constexpr ::std::ptrdiff_t _maxHealth = 0x248; // float
        constexpr ::std::ptrdiff_t faction = 0x24C; // BaseCombatEntity.Faction
        constexpr ::std::ptrdiff_t deathTime = 0x250; // float
        constexpr ::std::ptrdiff_t lastNotifyFrame = 0x254; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x430; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x4A0; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x510; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x580; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x5F0; // Option
        constexpr ::std::ptrdiff_t authorizedPlayers = 0x660; // List<PlayerNameID>
        constexpr ::std::ptrdiff_t allowedConstructionItems = 0x668; // List<ItemDefinition>
        constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x670; // float
        constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x674; // float
        constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x678; // float
    } // namespace BuildingPrivlidge
    ...
    namespace FishingBobber {
        constexpr ::std::ptrdiff_t centerOfMass = 0x258; // Transform
        constexpr ::std::ptrdiff_t myRigidBody = 0x260; // Rigidbody
        constexpr ::std::ptrdiff_t lineAttachPoint = 0x268; // Transform
        constexpr ::std::ptrdiff_t bobberRoot = 0x270; // Transform
        constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x278; // float
        constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x27C; // float
        constexpr ::std::ptrdiff_t SidewaysInputForce = 0x280; // float
        constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x284; // float
        constexpr ::std::ptrdiff_t fishLerp = 0x288; // float
        constexpr ::std::ptrdiff_t lastPosition = 0x28C; // Vector3
    } // namespace FishingBobber
