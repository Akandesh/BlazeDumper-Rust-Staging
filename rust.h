...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x33A47C8;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x33FD378;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34126E8;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x33E37A0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x33A4A58;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t maxProjectileID = 0x860; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x864; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x868; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x86C; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x870; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x874; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x878; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x87C; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x880; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x888; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x890; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x898; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x89C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x8A0; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x8A8; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x8B0; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x8B8; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x8C0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8C8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x8D0; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x8D8; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x8E0; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x8E8; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x8F0; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x8F8; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x900; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x908; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x910; // int
        constexpr ::std::ptrdiff_t reputation = 0x914; // int
        constexpr ::std::ptrdiff_t _displayName = 0x918; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x920; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x928; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x93C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x950; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x964; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x978; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x980; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x984; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x988; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x98C; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x990; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x994; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x998; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x99C; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x9A0; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x9A8; // BaseEntity
    } // namespace BasePlayer
