...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x344F630;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x34A8978;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34BE088;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x348E8A8;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x344F8E8;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t maxProjectileID = 0x868; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x86C; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x870; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x874; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x878; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x87C; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x880; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x884; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x888; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x890; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x898; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x8A0; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x8A4; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x8A8; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x8B0; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x8B8; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x8C0; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x8C8; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8D0; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x8D8; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x8E0; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x8E8; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x8F0; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x8F8; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x900; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x908; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x910; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x918; // int
        constexpr ::std::ptrdiff_t reputation = 0x91C; // int
        constexpr ::std::ptrdiff_t _displayName = 0x920; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x928; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x930; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x944; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x958; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x96C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x980; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x988; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x98C; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x990; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x994; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x998; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x99C; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x9A0; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x9A4; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x9A8; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x9B0; // BaseEntity
    } // namespace BasePlayer
