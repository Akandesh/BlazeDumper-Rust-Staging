...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3C65D20;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3C39CB8;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3C52278;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3C95190;
    constexpr ::std::ptrdiff_t ConVar_Admin_TypeInfo = 0x3C5B0B0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3C65F90;
    constexpr ::std::ptrdiff_t TOD_Sky_TypeInfo = 0x3C24928;
    constexpr ::std::ptrdiff_t BasePlayer_TypeInfo = 0x3C66D50;
    constexpr ::std::ptrdiff_t ConVar_Graphics_TypeInfo = 0x3C1BBF0;
    constexpr ::std::ptrdiff_t OcclusionCulling_TypeInfo = 0x3C66CC8;
    constexpr ::std::ptrdiff_t BaseNetworkable_TypeInfo = 0x3C66948;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t __menuOption_Menu_RemoveCuffs = 0x5D8; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RemoveHood = 0x650; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x6C8; // Option
        constexpr ::std::ptrdiff_t clanId = 0x740; // long
        constexpr ::std::ptrdiff_t playerModel = 0x748; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x750; // bool
        constexpr ::std::ptrdiff_t LookLocked = 0x751; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x758; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x760; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x768; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x770; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x778; // BaseCollision
        constexpr ::std::ptrdiff_t bagCount = 0x780; // int
        constexpr ::std::ptrdiff_t shelterCount = 0x784; // int
        constexpr ::std::ptrdiff_t modelInitUnderwear = 0x788; // uint
        constexpr ::std::ptrdiff_t _lookingAt = 0x790; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x798; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x7A0; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x7A8; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x7B4; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x7B8; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x7B9; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x7BA; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x7BB; // bool
        constexpr ::std::ptrdiff_t HasMountedClothing = 0x7BC; // bool
        constexpr ::std::ptrdiff_t HasWearableClothing = 0x7BD; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x7C0; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x7C4; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x7C8; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x7CC; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x7D0; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x7DC; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x7E8; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x7F0; // ViewModel
        constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x7F8; // RespawnInformation
        constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x800; // float
        constexpr ::std::ptrdiff_t lastParachuteRequest = 0x804; // TimeSince
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x808; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x80C; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x810; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x814; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x818; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x820; // Vector3
        constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x82C; // bool
        constexpr ::std::ptrdiff_t gestureList = 0x840; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x848; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x84C; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x850; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x858; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x860; // float
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x864; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x868; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x870; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x880; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x888; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x890; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x898; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x8A0; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x8A8; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x8B0; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x8B8; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x8C0; // bool
        constexpr ::std::ptrdiff_t missions = 0x8C8; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x8D0; // int
        constexpr ::std::ptrdiff_t modelState = 0x8D8; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x8E0; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x8F0; // float
        constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x8F4; // bool
        constexpr ::std::ptrdiff_t PetEntity = 0x8F8; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x900; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x904; // uint
        constexpr ::std::ptrdiff_t PetID = 0x908; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x910; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x918; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x91C; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x920; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x928; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x930; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x934; // bool
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x938; // float
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x93C; // bool
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x940; // BaseEntity
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x948; // float
        constexpr ::std::ptrdiff_t maxProjectileID = 0x94C; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x950; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x954; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x958; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x95C; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x960; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x968; // PlayerTick
        constexpr ::std::ptrdiff_t CurrentTutorialAllowance = 0x970; // BasePlayer.TutorialItemAllowance
        constexpr ::std::ptrdiff_t startTutorialCooldown = 0x974; // float
        constexpr ::std::ptrdiff_t nextVisThink = 0x978; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x97C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x980; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x988; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x990; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x998; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x9A0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x9A8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x9B0; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x9B8; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x9C0; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x9C8; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x9D0; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x9D8; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x9E0; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x9E8; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x9F0; // int
        constexpr ::std::ptrdiff_t reputation = 0x9F4; // int
        constexpr ::std::ptrdiff_t _displayName = 0x9F8; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0xA00; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0xA08; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0xA1C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0xA30; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0xA44; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0xA58; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0xA60; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0xA64; // float
        constexpr ::std::ptrdiff_t weaponMoveSpeedScale = 0xA68; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0xA6C; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0xA70; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0xA74; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0xA78; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0xA7C; // bool
        constexpr ::std::ptrdiff_t eggVision = 0xA80; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0xA88; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0xA90; // BaseEntity
    } // namespace BasePlayer
