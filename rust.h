...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3426150;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x347F138;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3494480;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3464408;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3426408;
    namespace BasePlayer {
        constexpr ::std::ptrdiff_t __menuOption_Climb = 0x278; // Option
        constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2F8; // Option
        ...
        constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x478; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x4F8; // Option
        constexpr ::std::ptrdiff_t __menuOption_Promote = 0x578; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x5F8; // Option
        constexpr ::std::ptrdiff_t clanId = 0x678; // long
        constexpr ::std::ptrdiff_t playerModel = 0x680; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x688; // bool
        constexpr ::std::ptrdiff_t LookLocked = 0x689; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x690; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x698; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x6A0; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x6A8; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x6B0; // BaseCollision
        constexpr ::std::ptrdiff_t bagCount = 0x6B8; // int
        constexpr ::std::ptrdiff_t shelterCount = 0x6BC; // int
        constexpr ::std::ptrdiff_t modelInitUnderwear = 0x6C0; // uint
        constexpr ::std::ptrdiff_t _lookingAt = 0x6C8; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x6D0; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x6D8; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x6E0; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x6EC; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x6F0; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x6F1; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x6F2; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x6F3; // bool
        constexpr ::std::ptrdiff_t HasMountedClothing = 0x6F4; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x6F8; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x6FC; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x700; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x704; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x708; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x714; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x720; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x728; // ViewModel
        constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x730; // RespawnInformation
        constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x738; // float
        constexpr ::std::ptrdiff_t lastParachuteRequest = 0x73C; // TimeSince
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x740; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x744; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x748; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x74C; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x750; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x758; // Vector3
        constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x764; // bool
        constexpr ::std::ptrdiff_t gestureList = 0x778; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x780; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x784; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x788; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x790; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x798; // float
        constexpr ::std::ptrdiff_t lastGestureCancel = 0x79C; // TimeSince
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x7A0; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x7A8; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x7B0; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x7B8; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x7C0; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x7C8; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x7D0; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x7D8; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x7E0; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x7E8; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x7F0; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x7F8; // bool
        constexpr ::std::ptrdiff_t missions = 0x800; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x808; // int
        constexpr ::std::ptrdiff_t modelState = 0x810; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x818; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x828; // float
        constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x82C; // bool
        constexpr ::std::ptrdiff_t PetEntity = 0x830; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x838; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x83C; // uint
        constexpr ::std::ptrdiff_t PetID = 0x840; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x848; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x850; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x854; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x858; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x860; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x868; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x86C; // bool
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x870; // float
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x874; // bool
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x878; // BaseEntity
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x880; // float
        constexpr ::std::ptrdiff_t maxProjectileID = 0x884; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x888; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x88C; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x890; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x894; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x898; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x89C; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x8A0; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x8A4; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x8A8; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x8B0; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x8B8; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x8BC; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x8C0; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x8C8; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x8D0; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x8D8; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x8E0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8E8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x8F0; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x8F8; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x900; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x908; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x910; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x918; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x920; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x928; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x930; // int
        constexpr ::std::ptrdiff_t reputation = 0x934; // int
        constexpr ::std::ptrdiff_t _displayName = 0x938; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x940; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x948; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x95C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x970; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x984; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x998; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x9A0; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x9A4; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x9A8; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x9AC; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x9B0; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x9B4; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x9B8; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x9BC; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x9C0; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x9C8; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        constexpr ::std::ptrdiff_t skeletonProperties = 0x1E8; // SkeletonProperties
        constexpr ::std::ptrdiff_t baseProtection = 0x1F0; // ProtectionProperties
        constexpr ::std::ptrdiff_t startHealth = 0x1F8; // float
        constexpr ::std::ptrdiff_t pickup = 0x200; // BaseCombatEntity.Pickup
        constexpr ::std::ptrdiff_t repair = 0x228; // BaseCombatEntity.Repair
        constexpr ::std::ptrdiff_t ShowHealthInfo = 0x258; // bool
        constexpr ::std::ptrdiff_t lifestate = 0x25C; // BaseCombatEntity.LifeState
        constexpr ::std::ptrdiff_t sendsHitNotification = 0x260; // bool
        constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x261; // bool
        constexpr ::std::ptrdiff_t markAttackerHostile = 0x262; // bool
        constexpr ::std::ptrdiff_t _health = 0x264; // float
        constexpr ::std::ptrdiff_t _maxHealth = 0x268; // float
        constexpr ::std::ptrdiff_t faction = 0x26C; // BaseCombatEntity.Faction
        constexpr ::std::ptrdiff_t deathTime = 0x270; // float
        constexpr ::std::ptrdiff_t lastNotifyFrame = 0x274; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x488; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x508; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x588; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x608; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x688; // Option
        constexpr ::std::ptrdiff_t authorizedPlayers = 0x708; // List<PlayerNameID>
        constexpr ::std::ptrdiff_t allowedConstructionItems = 0x710; // List<ItemDefinition>
        constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x718; // float
        constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x71C; // float
        constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x720; // float
    } // namespace BuildingPrivlidge
    namespace BaseProjectile {
        ...
        constexpr ::std::ptrdiff_t resetDuration = 0x324; // float
        constexpr ::std::ptrdiff_t numShotsFired = 0x328; // int
        constexpr ::std::ptrdiff_t nextReloadTime = 0x32C; // float
        constexpr ::std::ptrdiff_t startReloadTime = 0x330; // float
        constexpr ::std::ptrdiff_t stancePenalty = 0x334; // float
        constexpr ::std::ptrdiff_t aimconePenalty = 0x338; // float
        constexpr ::std::ptrdiff_t cachedModHash = 0x33C; // uint
        constexpr ::std::ptrdiff_t sightAimConeScale = 0x340; // float
        constexpr ::std::ptrdiff_t sightAimConeOffset = 0x344; // float
        constexpr ::std::ptrdiff_t hipAimConeScale = 0x348; // float
        constexpr ::std::ptrdiff_t hipAimConeOffset = 0x34C; // float
        constexpr ::std::ptrdiff_t isReloading = 0x350; // bool
        constexpr ::std::ptrdiff_t timeSinceReloadFinished = 0x354; // TimeSince
        constexpr ::std::ptrdiff_t swaySampleTime = 0x358; // float
        constexpr ::std::ptrdiff_t lastShotTime = 0x35C; // float
        constexpr ::std::ptrdiff_t reloadPressTime = 0x360; // float
        constexpr ::std::ptrdiff_t ammoTypePreReload = 0x368; // ItemDefinition
        constexpr ::std::ptrdiff_t fractionalReloadDesiredCount = 0x370; // int
        constexpr ::std::ptrdiff_t fractionalReloadNumAdded = 0x374; // int
        constexpr ::std::ptrdiff_t currentBurst = 0x378; // int
        constexpr ::std::ptrdiff_t triggerReady = 0x37C; // bool
        constexpr ::std::ptrdiff_t nextHeightCheckTime = 0x380; // float
        constexpr ::std::ptrdiff_t cachedUnderground = 0x384; // bool
        constexpr ::std::ptrdiff_t createdProjectiles = 0x388; // List<Projectile>
    } // namespace BaseProjectile
    namespace Magazine {
    ...
    namespace FishingBobber {
        constexpr ::std::ptrdiff_t centerOfMass = 0x278; // Transform
        constexpr ::std::ptrdiff_t myRigidBody = 0x280; // Rigidbody
        constexpr ::std::ptrdiff_t lineAttachPoint = 0x288; // Transform
        constexpr ::std::ptrdiff_t bobberRoot = 0x290; // Transform
        constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x298; // float
        constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x29C; // float
        constexpr ::std::ptrdiff_t SidewaysInputForce = 0x2A0; // float
        constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x2A4; // float
        constexpr ::std::ptrdiff_t fishLerp = 0x2A8; // float
        constexpr ::std::ptrdiff_t lastPosition = 0x2AC; // Vector3
    } // namespace FishingBobber
