...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3215AC8;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3217678;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3227DC0;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t lastSentTick = 0x658; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x660; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x664; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x668; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x670; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x678; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x680; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x688; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x690; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x698; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x6A0; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x6A8; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x6B0; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x6B8; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x6C0; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x6C8; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x6D0; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x6D8; // int
        constexpr ::std::ptrdiff_t reputation = 0x6DC; // int
        constexpr ::std::ptrdiff_t _displayName = 0x6E0; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x6E8; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x6F0; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x704; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x718; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x72C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x740; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x748; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x74C; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x750; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x754; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x758; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x75C; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x760; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x764; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x768; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x770; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseProjectile {
        ...
        constexpr ::std::ptrdiff_t isReloading = 0x32C; // bool
        constexpr ::std::ptrdiff_t swaySampleTime = 0x330; // float
        constexpr ::std::ptrdiff_t lastShotTime = 0x334; // float
        constexpr ::std::ptrdiff_t reloadPressTime = 0x338; // float
        constexpr ::std::ptrdiff_t ammoTypePreReload = 0x340; // ItemDefinition
        constexpr ::std::ptrdiff_t fractionalReloadDesiredCount = 0x348; // int
        constexpr ::std::ptrdiff_t fractionalReloadNumAdded = 0x34C; // int
        constexpr ::std::ptrdiff_t triggerReady = 0x350; // bool
        constexpr ::std::ptrdiff_t nextHeightCheckTime = 0x354; // float
        constexpr ::std::ptrdiff_t cachedUnderground = 0x358; // bool
        constexpr ::std::ptrdiff_t createdProjectiles = 0x360; // List<Projectile>
    } // namespace BaseProjectile
    namespace Magazine {
