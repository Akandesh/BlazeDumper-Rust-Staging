...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x347FFE0;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x34D9768;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34EEE70;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x34BF460;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3480298;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t modelInitUnderwear = 0x6B4; // uint
        constexpr ::std::ptrdiff_t _lookingAt = 0x6B8; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x6C0; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x6C8; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x6D0; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x6DC; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x6E0; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x6E1; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x6E2; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x6E3; // bool
        constexpr ::std::ptrdiff_t HasMountedClothing = 0x6E4; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x6E8; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x6EC; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x6F0; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x6F4; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x6F8; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x704; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x710; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x718; // ViewModel
        constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x720; // RespawnInformation
        constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x728; // float
        constexpr ::std::ptrdiff_t lastParachuteRequest = 0x72C; // TimeSince
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x730; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x734; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x738; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x73C; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x740; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x748; // Vector3
        constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x754; // bool
        constexpr ::std::ptrdiff_t gestureList = 0x768; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x770; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x774; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x778; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x780; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x788; // float
        constexpr ::std::ptrdiff_t lastGestureCancel = 0x78C; // TimeSince
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x790; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x798; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x7A0; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x7A8; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x7B0; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x7B8; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x7C0; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x7C8; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x7D0; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x7D8; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x7E0; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x7E8; // bool
        constexpr ::std::ptrdiff_t missions = 0x7F0; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x7F8; // int
        constexpr ::std::ptrdiff_t modelState = 0x800; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x808; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x818; // float
        constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x81C; // bool
        constexpr ::std::ptrdiff_t PetEntity = 0x820; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x828; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x82C; // uint
        constexpr ::std::ptrdiff_t PetID = 0x830; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x838; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x840; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x844; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x848; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x850; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x858; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x85C; // bool
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x860; // float
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x864; // bool
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x868; // BaseEntity
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x870; // float
        constexpr ::std::ptrdiff_t maxProjectileID = 0x874; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x878; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x87C; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x880; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x884; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x888; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x88C; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x890; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x894; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x898; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x8A0; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x8A8; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x8AC; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x8B0; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x8B8; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x8C0; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x8C8; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x8D0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8D8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x8E0; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x8E8; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x8F0; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x8F8; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x900; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x908; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x910; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x918; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x920; // int
        constexpr ::std::ptrdiff_t reputation = 0x924; // int
        constexpr ::std::ptrdiff_t _displayName = 0x928; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x930; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x938; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x94C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x960; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x974; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x988; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x990; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x994; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x998; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x99C; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x9A0; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x9A4; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x9A8; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x9AC; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x9B0; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x9B8; // BaseEntity
    } // namespace BasePlayer
