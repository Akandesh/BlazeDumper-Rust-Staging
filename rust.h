...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3369E20;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x33C25E0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x33D6CA8;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x33A96B0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x336A0B0;
    namespace BasePlayer {
        constexpr ::std::ptrdiff_t __menuOption_Climb = 0x260; // Option
        constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2D0; // Option
        constexpr ::std::ptrdiff_t __menuOption_InviteToClan = 0x340; // Option
        constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x3B0; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x420; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x490; // Option
        constexpr ::std::ptrdiff_t __menuOption_Promote = 0x500; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x570; // Option
        constexpr ::std::ptrdiff_t clanId = 0x5E0; // long
        constexpr ::std::ptrdiff_t playerModel = 0x5E8; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x5F0; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x5F8; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x600; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x608; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x610; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x618; // BaseCollision
        constexpr ::std::ptrdiff_t bagCount = 0x620; // int
        constexpr ::std::ptrdiff_t modelInitUnderwear = 0x624; // uint
        ...
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x718; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x720; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x728; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x730; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x738; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x740; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x748; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x750; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x758; // bool
        constexpr ::std::ptrdiff_t missions = 0x760; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x768; // int
        ...
        constexpr ::std::ptrdiff_t PetID = 0x7A0; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x7A8; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x7B0; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x7B4; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x7B8; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x7C0; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x7C8; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x7CC; // bool
        constexpr ::std::ptrdiff_t maxProjectileID = 0x7D0; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x7D4; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x7D8; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x7DC; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x7E0; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x7E4; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x7E8; // float
        ...
        constexpr ::std::ptrdiff_t nextVisThink = 0x800; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x804; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x808; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x810; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x818; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x820; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x828; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x830; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x838; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x840; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x848; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x850; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x858; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x860; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x868; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x870; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x878; // int
        constexpr ::std::ptrdiff_t reputation = 0x87C; // int
        constexpr ::std::ptrdiff_t _displayName = 0x880; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x888; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x890; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x8A4; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x8B8; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x8CC; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x8E0; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x8E8; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x8EC; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x8F0; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x8F4; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x8F8; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x8FC; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x900; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x904; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x908; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x910; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        constexpr ::std::ptrdiff_t repair = 0x218; // BaseCombatEntity.Repair
        constexpr ::std::ptrdiff_t ShowHealthInfo = 0x240; // bool
        constexpr ::std::ptrdiff_t lifestate = 0x244; // BaseCombatEntity.LifeState
        constexpr ::std::ptrdiff_t sendsHitNotification = 0x248; // bool
        constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x249; // bool
        constexpr ::std::ptrdiff_t markAttackerHostile = 0x24A; // bool
        constexpr ::std::ptrdiff_t _health = 0x24C; // float
        constexpr ::std::ptrdiff_t _maxHealth = 0x250; // float
        constexpr ::std::ptrdiff_t faction = 0x254; // BaseCombatEntity.Faction
        constexpr ::std::ptrdiff_t deathTime = 0x258; // float
        constexpr ::std::ptrdiff_t lastNotifyFrame = 0x25C; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x440; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x4B0; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x520; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x590; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x600; // Option
        constexpr ::std::ptrdiff_t authorizedPlayers = 0x670; // List<PlayerNameID>
        constexpr ::std::ptrdiff_t allowedConstructionItems = 0x678; // List<ItemDefinition>
        constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x680; // float
        constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x684; // float
        constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x688; // float
    } // namespace BuildingPrivlidge
    ...
    namespace FishingBobber {
        constexpr ::std::ptrdiff_t centerOfMass = 0x260; // Transform
        constexpr ::std::ptrdiff_t myRigidBody = 0x268; // Rigidbody
        constexpr ::std::ptrdiff_t lineAttachPoint = 0x270; // Transform
        constexpr ::std::ptrdiff_t bobberRoot = 0x278; // Transform
        constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x280; // float
        constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x284; // float
        constexpr ::std::ptrdiff_t SidewaysInputForce = 0x288; // float
        constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x28C; // float
        constexpr ::std::ptrdiff_t fishLerp = 0x290; // float
        constexpr ::std::ptrdiff_t lastPosition = 0x294; // Vector3
    } // namespace FishingBobber
