...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x339E5A8;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x33F71A0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x340C428;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x33DD6B0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x339E840;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t serverTickRate = 0x86C; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x870; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x874; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x878; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x87C; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x880; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x888; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x890; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x894; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x898; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x8A0; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x8A8; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x8B0; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x8B8; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8C0; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x8C8; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x8D0; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x8D8; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x8E0; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x8E8; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x8F0; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x8F8; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x900; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x908; // int
        constexpr ::std::ptrdiff_t reputation = 0x90C; // int
        constexpr ::std::ptrdiff_t _displayName = 0x910; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x918; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x920; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x934; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x948; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x95C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x970; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x978; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x97C; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x980; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x984; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x988; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x98C; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x990; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x994; // float
