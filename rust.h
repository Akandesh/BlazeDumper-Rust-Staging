...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3C735F0;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3C473A0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3C5F960;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3CA29B8;
    constexpr ::std::ptrdiff_t ConVar_Admin_TypeInfo = 0x3C686C0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3C73860;
    constexpr ::std::ptrdiff_t TOD_Sky_TypeInfo = 0x3C320E8;
    constexpr ::std::ptrdiff_t BasePlayer_TypeInfo = 0x3C74630;
    constexpr ::std::ptrdiff_t ConVar_Graphics_TypeInfo = 0x3C292D8;
    constexpr ::std::ptrdiff_t OcclusionCulling_TypeInfo = 0x3C74748;
    constexpr ::std::ptrdiff_t BaseNetworkable_TypeInfo = 0x3C74220;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x560; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_Push = 0x5D8; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RemoveCuffs = 0x650; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RemoveHood = 0x6C8; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x740; // Option
        constexpr ::std::ptrdiff_t clanId = 0x7B8; // long
        constexpr ::std::ptrdiff_t playerModel = 0x7C0; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x7C8; // bool
        constexpr ::std::ptrdiff_t LookLocked = 0x7C9; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x7D0; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x7D8; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x7E0; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x7E8; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x7F0; // BaseCollision
        constexpr ::std::ptrdiff_t bagCount = 0x7F8; // int
        constexpr ::std::ptrdiff_t shelterCount = 0x7FC; // int
        constexpr ::std::ptrdiff_t modelInitUnderwear = 0x800; // uint
        constexpr ::std::ptrdiff_t _lookingAt = 0x808; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x810; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x818; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x820; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x82C; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x830; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x831; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x832; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x833; // bool
        constexpr ::std::ptrdiff_t HasMountedClothing = 0x834; // bool
        constexpr ::std::ptrdiff_t HasWearableClothing = 0x835; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x838; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x83C; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x840; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x844; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x848; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x854; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x860; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x868; // ViewModel
        constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x870; // RespawnInformation
        constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x878; // float
        constexpr ::std::ptrdiff_t lastParachuteRequest = 0x87C; // TimeSince
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x880; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x884; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x888; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x88C; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x890; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x898; // Vector3
        constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x8A4; // bool
        constexpr ::std::ptrdiff_t gestureList = 0x8B8; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x8C0; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x8C4; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x8C8; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x8D0; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x8D8; // float
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x8DC; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x8E0; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x8E8; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x8F8; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x900; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x908; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x910; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x918; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x920; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x928; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x930; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x938; // bool
        constexpr ::std::ptrdiff_t missions = 0x940; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x948; // int
        constexpr ::std::ptrdiff_t modelState = 0x950; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x958; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x968; // float
        constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x96C; // bool
        constexpr ::std::ptrdiff_t PetEntity = 0x970; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x978; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x97C; // uint
        constexpr ::std::ptrdiff_t PetID = 0x980; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x988; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x990; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x994; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x998; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x9A0; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x9A8; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x9AC; // bool
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x9B0; // float
        constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x9B4; // bool
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x9B8; // BaseEntity
        constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x9C0; // float
        constexpr ::std::ptrdiff_t maxProjectileID = 0x9C4; // int
        constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x9C8; // TimeSince
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x9CC; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x9D0; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x9D4; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x9D8; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x9E0; // PlayerTick
        constexpr ::std::ptrdiff_t CurrentTutorialAllowance = 0x9E8; // BasePlayer.TutorialItemAllowance
        constexpr ::std::ptrdiff_t startTutorialCooldown = 0x9EC; // float
        constexpr ::std::ptrdiff_t nextVisThink = 0x9F0; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x9F4; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x9F8; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0xA00; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0xA08; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0xA10; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0xA18; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0xA20; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0xA28; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0xA30; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0xA38; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0xA40; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0xA48; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0xA50; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0xA58; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0xA60; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0xA68; // int
        constexpr ::std::ptrdiff_t reputation = 0xA6C; // int
        constexpr ::std::ptrdiff_t _displayName = 0xA70; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0xA78; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0xA80; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0xA94; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0xAA8; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0xABC; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0xAD0; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0xAD8; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0xADC; // float
        constexpr ::std::ptrdiff_t weaponMoveSpeedScale = 0xAE0; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0xAE4; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0xAE8; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0xAEC; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0xAF0; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0xAF4; // bool
        constexpr ::std::ptrdiff_t eggVision = 0xAF8; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0xB00; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0xB08; // BaseEntity
    } // namespace BasePlayer
