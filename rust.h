...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F61FA0;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FB15F0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2FC2BA8;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2FA07B8;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F62208;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t _lookingAt = 0x560; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x568; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x570; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x578; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x584; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x588; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x589; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x58A; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x58B; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x58C; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x590; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x594; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x598; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x59C; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x5A8; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x5B4; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x5B8; // ViewModel
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x5C0; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x5C4; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x5C8; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x5CC; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x5D0; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x5D8; // Vector3
        constexpr ::std::ptrdiff_t gestureList = 0x5E8; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x5F0; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x5F4; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x5F8; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x600; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x608; // float
        constexpr ::std::ptrdiff_t lastGestureCancel = 0x60C; // TimeSince
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x610; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x618; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x620; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x628; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x630; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x638; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x640; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x648; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x650; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x658; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x660; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x668; // bool
        constexpr ::std::ptrdiff_t missions = 0x670; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x678; // int
        constexpr ::std::ptrdiff_t modelState = 0x680; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x688; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x698; // float
        constexpr ::std::ptrdiff_t PetEntity = 0x6A0; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x6A8; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x6AC; // uint
        constexpr ::std::ptrdiff_t PetID = 0x6B0; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x6B8; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x6C0; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x6C4; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x6C8; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x6D0; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t maxProjectileID = 0x6D8; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x6DC; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x6E0; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x6E4; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x6E8; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x6EC; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x6F0; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x6F4; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x6F8; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x700; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x708; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x70C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x710; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x718; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x720; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x728; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x730; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x738; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x740; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x748; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x750; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x758; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x760; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x768; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x770; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x778; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x780; // int
        constexpr ::std::ptrdiff_t reputation = 0x784; // int
        constexpr ::std::ptrdiff_t _displayName = 0x788; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x790; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x798; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x7AC; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x7C0; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x7D4; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x7E8; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x7F0; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x7F4; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x7F8; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x7FC; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x800; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x804; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x808; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x80C; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x810; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x818; // BaseEntity
    } // namespace BasePlayer
