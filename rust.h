...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3277C08;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3279840;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x328A008;
