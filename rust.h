...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x39D9F60;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x39A30E0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x39BCCA0;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3A15158;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x39DA220;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t eyes = 0x8F0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x8F8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x900; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x908; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x910; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x918; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x920; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x928; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x930; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x938; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x940; // int
        constexpr ::std::ptrdiff_t reputation = 0x944; // int
        constexpr ::std::ptrdiff_t _displayName = 0x948; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x950; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x958; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x96C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x980; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x994; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x9A8; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x9B0; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x9B4; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x9B8; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x9BC; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x9C0; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x9C4; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x9C8; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x9CC; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x9D0; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x9D8; // BaseEntity
    } // namespace BasePlayer
