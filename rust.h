...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F52918;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FA18F0;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2FB2F08;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2F911F8;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F52B88;
    namespace BasePlayer {
        constexpr ::std::ptrdiff_t __menuOption_Climb = 0x248; // Option
        constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2A8; // Option
        constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x308; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x368; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x3C8; // Option
        constexpr ::std::ptrdiff_t __menuOption_Promote = 0x428; // Option
        constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x488; // Option
        constexpr ::std::ptrdiff_t playerModel = 0x4E8; // PlayerModel
        constexpr ::std::ptrdiff_t Frozen = 0x4F0; // bool
        constexpr ::std::ptrdiff_t voiceRecorder = 0x4F8; // PlayerVoiceRecorder
        constexpr ::std::ptrdiff_t voiceSpeaker = 0x500; // PlayerVoiceSpeaker
        constexpr ::std::ptrdiff_t input = 0x508; // PlayerInput
        constexpr ::std::ptrdiff_t movement = 0x510; // BaseMovement
        constexpr ::std::ptrdiff_t collision = 0x518; // BaseCollision
        constexpr ::std::ptrdiff_t _lookingAt = 0x520; // GameObject
        constexpr ::std::ptrdiff_t _lookingAtEntity = 0x528; // BaseEntity
        constexpr ::std::ptrdiff_t _lookingAtCollider = 0x530; // Collider
        constexpr ::std::ptrdiff_t lookingAtPoint = 0x538; // Vector3
        constexpr ::std::ptrdiff_t wakeTime = 0x544; // float
        constexpr ::std::ptrdiff_t needsClothesRebuild = 0x548; // bool
        constexpr ::std::ptrdiff_t wasSleeping = 0x549; // bool
        constexpr ::std::ptrdiff_t wokeUpBefore = 0x54A; // bool
        constexpr ::std::ptrdiff_t wasDead = 0x54B; // bool
        constexpr ::std::ptrdiff_t lastClothesHash = 0x54C; // uint
        constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x550; // TimeSince
        constexpr ::std::ptrdiff_t currentViewMode = 0x554; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t selectedViewMode = 0x558; // BasePlayer.CameraMode
        constexpr ::std::ptrdiff_t lastRevivePoint = 0x55C; // Vector3
        constexpr ::std::ptrdiff_t lastReviveDirection = 0x568; // Vector3
        constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x574; // bool
        constexpr ::std::ptrdiff_t GestureViewModel = 0x578; // ViewModel
        constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x580; // RealTimeSince
        constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x584; // float
        constexpr ::std::ptrdiff_t usePressTime = 0x588; // float
        constexpr ::std::ptrdiff_t useHeldTime = 0x58C; // float
        constexpr ::std::ptrdiff_t lookingAtTest = 0x590; // HitTest
        constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x598; // Vector3
        constexpr ::std::ptrdiff_t gestureList = 0x5A8; // GestureCollection
        constexpr ::std::ptrdiff_t gestureFinishedTime = 0x5B0; // TimeUntil
        constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x5B4; // TimeSince
        constexpr ::std::ptrdiff_t currentGesture = 0x5B8; // GestureConfig
        constexpr ::std::ptrdiff_t disabledHeldEntity = 0x5C0; // HeldEntity
        constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x5C8; // float
        constexpr ::std::ptrdiff_t lastGestureCancel = 0x5CC; // TimeSince
        constexpr ::std::ptrdiff_t client_lastHelloTime = 0x5D0; // float
        constexpr ::std::ptrdiff_t currentTeam = 0x5D8; // ulong
        constexpr ::std::ptrdiff_t clientTeam = 0x5E0; // PlayerTeam
        constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x5E8; // float
        constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x5F0; // ulong
        constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x5F8; // int
        constexpr ::std::ptrdiff_t playerGroupKey = 0x600; // string
        constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x608; // string
        constexpr ::std::ptrdiff_t clActiveItem = 0x610; // ItemId
        constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x618; // List<MapNote>
        constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x620; // MapNote
        constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x628; // bool
        constexpr ::std::ptrdiff_t missions = 0x630; // List<BaseMission.MissionInstance>
        constexpr ::std::ptrdiff_t _activeMission = 0x638; // int
        constexpr ::std::ptrdiff_t modelState = 0x640; // ModelState
        constexpr ::std::ptrdiff_t mounted = 0x648; // EntityRef
        constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x658; // float
        constexpr ::std::ptrdiff_t PetEntity = 0x660; // BaseEntity
        constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x668; // float
        constexpr ::std::ptrdiff_t PetPrefabID = 0x66C; // uint
        constexpr ::std::ptrdiff_t PetID = 0x670; // NetworkableId
        constexpr ::std::ptrdiff_t ClientCurrentPings = 0x678; // List<MapNote>
        constexpr ::std::ptrdiff_t tapInProcess = 0x680; // bool
        constexpr ::std::ptrdiff_t lastPingTap = 0x684; // TimeSince
        constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x688; // float
        constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x690; // BuildingPrivlidge
        constexpr ::std::ptrdiff_t maxProjectileID = 0x698; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x69C; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x6A0; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x6A4; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x6A8; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x6AC; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x6B0; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x6B4; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x6B8; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x6C0; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x6C8; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x6CC; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x6D0; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x6D8; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x6E0; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x6E8; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x6F0; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x6F8; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x700; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x708; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x710; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x718; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x720; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x728; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x730; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x738; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x740; // int
        constexpr ::std::ptrdiff_t reputation = 0x744; // int
        constexpr ::std::ptrdiff_t _displayName = 0x748; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x750; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x758; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x76C; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x780; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x794; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x7A8; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x7B0; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x7B4; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x7B8; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x7BC; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x7C0; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x7C4; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x7C8; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x7CC; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x7D0; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x7D8; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        constexpr ::std::ptrdiff_t skeletonProperties = 0x1C8; // SkeletonProperties
        constexpr ::std::ptrdiff_t baseProtection = 0x1D0; // ProtectionProperties
        constexpr ::std::ptrdiff_t startHealth = 0x1D8; // float
        constexpr ::std::ptrdiff_t pickup = 0x1E0; // BaseCombatEntity.Pickup
        constexpr ::std::ptrdiff_t repair = 0x200; // BaseCombatEntity.Repair
        constexpr ::std::ptrdiff_t ShowHealthInfo = 0x228; // bool
        constexpr ::std::ptrdiff_t lifestate = 0x22C; // BaseCombatEntity.LifeState
        constexpr ::std::ptrdiff_t sendsHitNotification = 0x230; // bool
        constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x231; // bool
        constexpr ::std::ptrdiff_t markAttackerHostile = 0x232; // bool
        constexpr ::std::ptrdiff_t _health = 0x234; // float
        constexpr ::std::ptrdiff_t _maxHealth = 0x238; // float
        constexpr ::std::ptrdiff_t faction = 0x23C; // BaseCombatEntity.Faction
        constexpr ::std::ptrdiff_t deathTime = 0x240; // float
        constexpr ::std::ptrdiff_t lastNotifyFrame = 0x244; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x3F0; // Option
        constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x450; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x4B0; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x510; // Option
        constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x570; // Option
        constexpr ::std::ptrdiff_t authorizedPlayers = 0x5D0; // List<PlayerNameID>
        constexpr ::std::ptrdiff_t allowedConstructionItems = 0x5D8; // List<ItemDefinition>
        constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x5E0; // float
        constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x5E4; // float
        constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x5E8; // float
    } // namespace BuildingPrivlidge
    ...
    namespace Item {
        ...
        constexpr ::std::ptrdiff_t cookTimeLeft = 0x68; // float
        constexpr ::std::ptrdiff_t progressBar = 0x6C; // float
        constexpr ::std::ptrdiff_t flags = 0x78; // Item.Flag
        constexpr ::std::ptrdiff_t contents = 0x80; // ItemContainer
        constexpr ::std::ptrdiff_t parent = 0x88; // ItemContainer
        constexpr ::std::ptrdiff_t worldEnt = 0x90; // EntityRef
        constexpr ::std::ptrdiff_t heldEntity = 0xA0; // EntityRef
    } // namespace Item
    namespace Model {
    ...
    namespace FishingBobber {
        constexpr ::std::ptrdiff_t centerOfMass = 0x248; // Transform
        constexpr ::std::ptrdiff_t myRigidBody = 0x250; // Rigidbody
        constexpr ::std::ptrdiff_t lineAttachPoint = 0x258; // Transform
        constexpr ::std::ptrdiff_t bobberRoot = 0x260; // Transform
        constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x268; // float
        constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x26C; // float
        constexpr ::std::ptrdiff_t SidewaysInputForce = 0x270; // float
        constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x274; // float
        constexpr ::std::ptrdiff_t fishLerp = 0x278; // float
        constexpr ::std::ptrdiff_t lastPosition = 0x27C; // Vector3
    } // namespace FishingBobber
