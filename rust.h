...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2FAB230;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FFB0A8;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x300CDC8;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2FE9AF0;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2FAB4A0;
    namespace BasePlayer {
        ...
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x6F0; // float
        constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x6F4; // bool
        constexpr ::std::ptrdiff_t maxProjectileID = 0x6F8; // int
        constexpr ::std::ptrdiff_t lastUpdateTime = 0x6FC; // float
        constexpr ::std::ptrdiff_t cachedThreatLevel = 0x700; // float
        constexpr ::std::ptrdiff_t serverTickRate = 0x704; // int
        constexpr ::std::ptrdiff_t clientTickRate = 0x708; // int
        constexpr ::std::ptrdiff_t serverTickInterval = 0x70C; // float
        constexpr ::std::ptrdiff_t clientTickInterval = 0x710; // float
        constexpr ::std::ptrdiff_t lastSentTickTime = 0x714; // float
        constexpr ::std::ptrdiff_t lastTickStopwatch = 0x718; // Stopwatch
        constexpr ::std::ptrdiff_t lastSentTick = 0x720; // PlayerTick
        constexpr ::std::ptrdiff_t nextVisThink = 0x728; // float
        constexpr ::std::ptrdiff_t lastTimeSeen = 0x72C; // float
        constexpr ::std::ptrdiff_t debugPrevVisible = 0x730; // bool
        constexpr ::std::ptrdiff_t fallDamageEffect = 0x738; // GameObjectRef
        constexpr ::std::ptrdiff_t drownEffect = 0x740; // GameObjectRef
        constexpr ::std::ptrdiff_t playerFlags = 0x748; // BasePlayer.PlayerFlags
        constexpr ::std::ptrdiff_t eyes = 0x750; // PlayerEyes
        constexpr ::std::ptrdiff_t inventory = 0x758; // PlayerInventory
        constexpr ::std::ptrdiff_t blueprints = 0x760; // PlayerBlueprints
        constexpr ::std::ptrdiff_t metabolism = 0x768; // PlayerMetabolism
        constexpr ::std::ptrdiff_t modifiers = 0x770; // PlayerModifiers
        constexpr ::std::ptrdiff_t playerCollider = 0x778; // CapsuleCollider
        constexpr ::std::ptrdiff_t Belt = 0x780; // PlayerBelt
        constexpr ::std::ptrdiff_t playerRigidbody = 0x788; // Rigidbody
        constexpr ::std::ptrdiff_t userID = 0x790; // ulong
        constexpr ::std::ptrdiff_t UserIDString = 0x798; // string
        constexpr ::std::ptrdiff_t gamemodeteam = 0x7A0; // int
        constexpr ::std::ptrdiff_t reputation = 0x7A4; // int
        constexpr ::std::ptrdiff_t _displayName = 0x7A8; // string
        constexpr ::std::ptrdiff_t _lastSetName = 0x7B0; // string
        constexpr ::std::ptrdiff_t playerColliderStanding = 0x7B8; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderDucked = 0x7CC; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderCrawling = 0x7E0; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x7F4; // BasePlayer.CapsuleColliderInfo
        constexpr ::std::ptrdiff_t cachedProtection = 0x808; // ProtectionProperties
        constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x810; // float
        constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x814; // float
        constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x818; // bool
        constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x81C; // float
        constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x820; // float
        constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x824; // float
        constexpr ::std::ptrdiff_t equippingBlocked = 0x828; // bool
        constexpr ::std::ptrdiff_t eggVision = 0x82C; // float
        constexpr ::std::ptrdiff_t activeTelephone = 0x830; // PhoneController
        constexpr ::std::ptrdiff_t designingAIEntity = 0x838; // BaseEntity
    } // namespace BasePlayer
