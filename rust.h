...
namespace blazedumper {
    constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3AB8BA8;
    constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3A83928;
    constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3A9E180;
    constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x3AF3018;
    constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3AB8E90;
    ...
    namespace PlayerModel {
        ...
        constexpr ::std::ptrdiff_t fallingTime = 0x208; // float
        constexpr ::std::ptrdiff_t smoothLeftFootIK = 0x20C; // Vector3
        constexpr ::std::ptrdiff_t smoothRightFootIK = 0x218; // Vector3
        constexpr ::std::ptrdiff_t drawShadowOnly = 0x224; // bool
        constexpr ::std::ptrdiff_t isIncapacitated = 0x225; // bool
        constexpr ::std::ptrdiff_t flinchLocation = 0x228; // uint
        constexpr ::std::ptrdiff_t visible = 0x22C; // bool
        ...
        constexpr ::std::ptrdiff_t overrideLeftHandIkWeight = 0x320; // float
