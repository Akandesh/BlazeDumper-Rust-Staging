...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x33835D8;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x33DC170;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x33F1290;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x33C2B78;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3383870;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x864; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x868; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x86C; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x870; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x874; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x878; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x87C; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x880; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x888; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x890; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x894; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x898; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x8A0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x8A8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x8B0; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x8B8; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x8C0; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x8C8; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x8D0; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x8D8; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x8E0; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x8E8; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x8F0; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x8F8; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x900; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x908; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x90C; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x910; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x918; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x920; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x934; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x948; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x95C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x970; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x978; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x97C; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x980; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x984; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x988; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x98C; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x990; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x994; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x998; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x9A0; // BaseEntity
    } // namespace BasePlayer
