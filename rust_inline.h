...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2FA5100;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FF4F18;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3006B20;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2FE3948;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2FA5370;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x6F0; // int
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x6F4; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x6F8; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x6FC; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x700; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x704; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x708; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x70C; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x710; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x718; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x720; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x724; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x728; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x730; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x738; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x740; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x748; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x750; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x758; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x760; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x768; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x770; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x778; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x780; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x788; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x790; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x798; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x79C; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x7A0; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x7A8; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x7B0; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x7C4; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x7D8; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x7EC; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x800; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x808; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x80C; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x810; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x814; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x818; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x81C; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x820; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x824; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x828; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x830; // BaseEntity
    } // namespace BasePlayer
