...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2FAB228;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FFB0A0;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x300CDB8;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2FE9AE8;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2FAB498;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x320; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x388; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x3F0; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Promote = 0x458; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x4C0; // Option
        inline constexpr ::std::ptrdiff_t playerModel = 0x528; // PlayerModel
        inline constexpr ::std::ptrdiff_t Frozen = 0x530; // bool
        inline constexpr ::std::ptrdiff_t voiceRecorder = 0x538; // PlayerVoiceRecorder
        inline constexpr ::std::ptrdiff_t voiceSpeaker = 0x540; // PlayerVoiceSpeaker
        inline constexpr ::std::ptrdiff_t input = 0x548; // PlayerInput
        inline constexpr ::std::ptrdiff_t movement = 0x550; // BaseMovement
        inline constexpr ::std::ptrdiff_t collision = 0x558; // BaseCollision
        inline constexpr ::std::ptrdiff_t bagCount = 0x560; // int
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x568; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x570; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x578; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x580; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x58C; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x590; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x591; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x592; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x593; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x594; // uint
        inline constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x598; // TimeSince
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x59C; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x5A0; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x5A4; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x5B0; // Vector3
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x5BC; // bool
        inline constexpr ::std::ptrdiff_t GestureViewModel = 0x5C0; // ViewModel
        inline constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x5C8; // RespawnInformation
        inline constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x5D0; // float
        inline constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x5D4; // RealTimeSince
        inline constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x5D8; // float
        inline constexpr ::std::ptrdiff_t usePressTime = 0x5DC; // float
        inline constexpr ::std::ptrdiff_t useHeldTime = 0x5E0; // float
        inline constexpr ::std::ptrdiff_t lookingAtTest = 0x5E8; // HitTest
        inline constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x5F0; // Vector3
        inline constexpr ::std::ptrdiff_t gestureList = 0x600; // GestureCollection
        inline constexpr ::std::ptrdiff_t gestureFinishedTime = 0x608; // TimeUntil
        inline constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x60C; // TimeSince
        inline constexpr ::std::ptrdiff_t currentGesture = 0x610; // GestureConfig
        inline constexpr ::std::ptrdiff_t disabledHeldEntity = 0x618; // HeldEntity
        inline constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x620; // float
        inline constexpr ::std::ptrdiff_t lastGestureCancel = 0x624; // TimeSince
        inline constexpr ::std::ptrdiff_t client_lastHelloTime = 0x628; // float
        inline constexpr ::std::ptrdiff_t currentTeam = 0x630; // ulong
        inline constexpr ::std::ptrdiff_t clientTeam = 0x638; // PlayerTeam
        inline constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x640; // float
        inline constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x648; // ulong
        inline constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x650; // int
        inline constexpr ::std::ptrdiff_t playerGroupKey = 0x658; // string
        inline constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x660; // string
        inline constexpr ::std::ptrdiff_t clActiveItem = 0x668; // ItemId
        inline constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x670; // List<MapNote>
        inline constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x678; // MapNote
        inline constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x680; // bool
        inline constexpr ::std::ptrdiff_t missions = 0x688; // List<BaseMission.MissionInstance>
        inline constexpr ::std::ptrdiff_t _activeMission = 0x690; // int
        inline constexpr ::std::ptrdiff_t modelState = 0x698; // ModelState
        inline constexpr ::std::ptrdiff_t mounted = 0x6A0; // EntityRef
        inline constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x6B0; // float
        inline constexpr ::std::ptrdiff_t PetEntity = 0x6B8; // BaseEntity
        inline constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x6C0; // float
        inline constexpr ::std::ptrdiff_t PetPrefabID = 0x6C4; // uint
        inline constexpr ::std::ptrdiff_t PetID = 0x6C8; // NetworkableId
        inline constexpr ::std::ptrdiff_t ClientCurrentPings = 0x6D0; // List<MapNote>
        inline constexpr ::std::ptrdiff_t tapInProcess = 0x6D8; // bool
        inline constexpr ::std::ptrdiff_t lastPingTap = 0x6DC; // TimeSince
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x6E0; // float
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x6E8; // BuildingPrivlidge
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x6F0; // float
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x6F4; // bool
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x6F8; // int
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x6FC; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x700; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x704; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x708; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x70C; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x710; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x714; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x718; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x720; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x728; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x72C; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x730; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x738; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x740; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x748; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x750; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x758; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x760; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x768; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x770; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x778; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x780; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x788; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x790; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x798; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x7A0; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x7A4; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x7A8; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x7B0; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x7B8; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x7CC; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x7E0; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x7F4; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x808; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x810; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x814; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x818; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x81C; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x820; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x824; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x828; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x82C; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x830; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x838; // BaseEntity
    } // namespace BasePlayer
