...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x33AB9D0;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3404508;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3419878;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x33EA898;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x33ABC68;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x860; // int
        inline constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x864; // TimeSince
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x868; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x86C; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x870; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x874; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x878; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x87C; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x880; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x888; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x890; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x898; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x89C; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x8A0; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x8A8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x8B0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x8B8; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x8C0; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x8C8; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x8D0; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x8D8; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x8E0; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x8E8; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x8F0; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x8F8; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x900; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x908; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x910; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x914; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x918; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x920; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x928; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x93C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x950; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x964; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x978; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x980; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x984; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x988; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x98C; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x990; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x994; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x998; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x99C; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x9A0; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x9A8; // BaseEntity
    } // namespace BasePlayer
