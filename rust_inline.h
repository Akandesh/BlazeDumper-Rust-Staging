...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F56988;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FA5A30;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2FB7060;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2F95250;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F56BF8;
    namespace BasePlayer {
        inline constexpr ::std::ptrdiff_t __menuOption_Climb = 0x248; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2A8; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x308; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x368; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x3C8; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Promote = 0x428; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x488; // Option
        inline constexpr ::std::ptrdiff_t playerModel = 0x4E8; // PlayerModel
        inline constexpr ::std::ptrdiff_t Frozen = 0x4F0; // bool
        inline constexpr ::std::ptrdiff_t voiceRecorder = 0x4F8; // PlayerVoiceRecorder
        inline constexpr ::std::ptrdiff_t voiceSpeaker = 0x500; // PlayerVoiceSpeaker
        inline constexpr ::std::ptrdiff_t input = 0x508; // PlayerInput
        inline constexpr ::std::ptrdiff_t movement = 0x510; // BaseMovement
        inline constexpr ::std::ptrdiff_t collision = 0x518; // BaseCollision
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x520; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x528; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x530; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x538; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x544; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x548; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x549; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x54A; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x54B; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x54C; // uint
        inline constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x550; // TimeSince
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x554; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x558; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x55C; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x568; // Vector3
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x574; // bool
        inline constexpr ::std::ptrdiff_t GestureViewModel = 0x578; // ViewModel
        inline constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x580; // RealTimeSince
        inline constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x584; // float
        inline constexpr ::std::ptrdiff_t usePressTime = 0x588; // float
        inline constexpr ::std::ptrdiff_t useHeldTime = 0x58C; // float
        inline constexpr ::std::ptrdiff_t lookingAtTest = 0x590; // HitTest
        inline constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x598; // Vector3
        inline constexpr ::std::ptrdiff_t gestureList = 0x5A8; // GestureCollection
        inline constexpr ::std::ptrdiff_t gestureFinishedTime = 0x5B0; // TimeUntil
        inline constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x5B4; // TimeSince
        inline constexpr ::std::ptrdiff_t currentGesture = 0x5B8; // GestureConfig
        inline constexpr ::std::ptrdiff_t disabledHeldEntity = 0x5C0; // HeldEntity
        inline constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x5C8; // float
        inline constexpr ::std::ptrdiff_t lastGestureCancel = 0x5CC; // TimeSince
        inline constexpr ::std::ptrdiff_t client_lastHelloTime = 0x5D0; // float
        inline constexpr ::std::ptrdiff_t currentTeam = 0x5D8; // ulong
        inline constexpr ::std::ptrdiff_t clientTeam = 0x5E0; // PlayerTeam
        inline constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x5E8; // float
        inline constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x5F0; // ulong
        inline constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x5F8; // int
        inline constexpr ::std::ptrdiff_t playerGroupKey = 0x600; // string
        inline constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x608; // string
        inline constexpr ::std::ptrdiff_t clActiveItem = 0x610; // ItemId
        inline constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x618; // List<MapNote>
        inline constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x620; // MapNote
        inline constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x628; // bool
        inline constexpr ::std::ptrdiff_t missions = 0x630; // List<BaseMission.MissionInstance>
        inline constexpr ::std::ptrdiff_t _activeMission = 0x638; // int
        inline constexpr ::std::ptrdiff_t modelState = 0x640; // ModelState
        inline constexpr ::std::ptrdiff_t mounted = 0x648; // EntityRef
        inline constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x658; // float
        inline constexpr ::std::ptrdiff_t PetEntity = 0x660; // BaseEntity
        inline constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x668; // float
        inline constexpr ::std::ptrdiff_t PetPrefabID = 0x66C; // uint
        inline constexpr ::std::ptrdiff_t PetID = 0x670; // NetworkableId
        inline constexpr ::std::ptrdiff_t ClientCurrentPings = 0x678; // List<MapNote>
        inline constexpr ::std::ptrdiff_t tapInProcess = 0x680; // bool
        inline constexpr ::std::ptrdiff_t lastPingTap = 0x684; // TimeSince
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x688; // float
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x690; // BuildingPrivlidge
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x698; // int
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x69C; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x6A0; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x6A4; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x6A8; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x6AC; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x6B0; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x6B4; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x6B8; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x6C0; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x6C8; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x6CC; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x6D0; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x6D8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x6E0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x6E8; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x6F0; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x6F8; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x700; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x708; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x710; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x718; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x720; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x728; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x730; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x738; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x740; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x744; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x748; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x750; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x758; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x76C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x780; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x794; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x7A8; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x7B0; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x7B4; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x7B8; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x7BC; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x7C0; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x7C4; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x7C8; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x7CC; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x7D0; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x7D8; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        inline constexpr ::std::ptrdiff_t skeletonProperties = 0x1C8; // SkeletonProperties
        inline constexpr ::std::ptrdiff_t baseProtection = 0x1D0; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t startHealth = 0x1D8; // float
        inline constexpr ::std::ptrdiff_t pickup = 0x1E0; // BaseCombatEntity.Pickup
        inline constexpr ::std::ptrdiff_t repair = 0x200; // BaseCombatEntity.Repair
        inline constexpr ::std::ptrdiff_t ShowHealthInfo = 0x228; // bool
        inline constexpr ::std::ptrdiff_t lifestate = 0x22C; // BaseCombatEntity.LifeState
        inline constexpr ::std::ptrdiff_t sendsHitNotification = 0x230; // bool
        inline constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x231; // bool
        inline constexpr ::std::ptrdiff_t markAttackerHostile = 0x232; // bool
        inline constexpr ::std::ptrdiff_t _health = 0x234; // float
        inline constexpr ::std::ptrdiff_t _maxHealth = 0x238; // float
        inline constexpr ::std::ptrdiff_t faction = 0x23C; // BaseCombatEntity.Faction
        inline constexpr ::std::ptrdiff_t deathTime = 0x240; // float
        inline constexpr ::std::ptrdiff_t lastNotifyFrame = 0x244; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x3F0; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x450; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x4B0; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x510; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x570; // Option
        inline constexpr ::std::ptrdiff_t authorizedPlayers = 0x5D0; // List<PlayerNameID>
        inline constexpr ::std::ptrdiff_t allowedConstructionItems = 0x5D8; // List<ItemDefinition>
        inline constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x5E0; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x5E4; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x5E8; // float
    } // namespace BuildingPrivlidge
    ...
    namespace FishingBobber {
        inline constexpr ::std::ptrdiff_t centerOfMass = 0x248; // Transform
        inline constexpr ::std::ptrdiff_t myRigidBody = 0x250; // Rigidbody
        inline constexpr ::std::ptrdiff_t lineAttachPoint = 0x258; // Transform
        inline constexpr ::std::ptrdiff_t bobberRoot = 0x260; // Transform
        inline constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x268; // float
        inline constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x26C; // float
        inline constexpr ::std::ptrdiff_t SidewaysInputForce = 0x270; // float
        inline constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x274; // float
