...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3479D20;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x34D3220;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34E8930;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x34B8FC0;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3479FD8;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t modelInitUnderwear = 0x6B4; // uint
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x6B8; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x6C0; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x6C8; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x6D0; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x6DC; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x6E0; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x6E1; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x6E2; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x6E3; // bool
        inline constexpr ::std::ptrdiff_t HasMountedClothing = 0x6E4; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x6E8; // uint
        inline constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x6EC; // TimeSince
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x6F0; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x6F4; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x6F8; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x704; // Vector3
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x710; // bool
        inline constexpr ::std::ptrdiff_t GestureViewModel = 0x718; // ViewModel
        inline constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x720; // RespawnInformation
        inline constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x728; // float
        inline constexpr ::std::ptrdiff_t lastParachuteRequest = 0x72C; // TimeSince
        inline constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x730; // RealTimeSince
        inline constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x734; // float
        inline constexpr ::std::ptrdiff_t usePressTime = 0x738; // float
        inline constexpr ::std::ptrdiff_t useHeldTime = 0x73C; // float
        inline constexpr ::std::ptrdiff_t lookingAtTest = 0x740; // HitTest
        inline constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x748; // Vector3
        inline constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x754; // bool
        inline constexpr ::std::ptrdiff_t gestureList = 0x768; // GestureCollection
        inline constexpr ::std::ptrdiff_t gestureFinishedTime = 0x770; // TimeUntil
        inline constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x774; // TimeSince
        inline constexpr ::std::ptrdiff_t currentGesture = 0x778; // GestureConfig
        inline constexpr ::std::ptrdiff_t disabledHeldEntity = 0x780; // HeldEntity
        inline constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x788; // float
        inline constexpr ::std::ptrdiff_t lastGestureCancel = 0x78C; // TimeSince
        inline constexpr ::std::ptrdiff_t client_lastHelloTime = 0x790; // float
        inline constexpr ::std::ptrdiff_t currentTeam = 0x798; // ulong
        inline constexpr ::std::ptrdiff_t clientTeam = 0x7A0; // PlayerTeam
        inline constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x7A8; // float
        inline constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x7B0; // ulong
        inline constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x7B8; // int
        inline constexpr ::std::ptrdiff_t playerGroupKey = 0x7C0; // string
        inline constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x7C8; // string
        inline constexpr ::std::ptrdiff_t clActiveItem = 0x7D0; // ItemId
        inline constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x7D8; // List<MapNote>
        inline constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x7E0; // MapNote
        inline constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x7E8; // bool
        inline constexpr ::std::ptrdiff_t missions = 0x7F0; // List<BaseMission.MissionInstance>
        inline constexpr ::std::ptrdiff_t _activeMission = 0x7F8; // int
        inline constexpr ::std::ptrdiff_t modelState = 0x800; // ModelState
        inline constexpr ::std::ptrdiff_t mounted = 0x808; // EntityRef
        inline constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x818; // float
        inline constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x81C; // bool
        inline constexpr ::std::ptrdiff_t PetEntity = 0x820; // BaseEntity
        inline constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x828; // float
        inline constexpr ::std::ptrdiff_t PetPrefabID = 0x82C; // uint
        inline constexpr ::std::ptrdiff_t PetID = 0x830; // NetworkableId
        inline constexpr ::std::ptrdiff_t ClientCurrentPings = 0x838; // List<MapNote>
        inline constexpr ::std::ptrdiff_t tapInProcess = 0x840; // bool
        inline constexpr ::std::ptrdiff_t lastPingTap = 0x844; // TimeSince
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x848; // float
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x850; // BuildingPrivlidge
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x858; // float
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x85C; // bool
        inline constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x860; // float
        inline constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x864; // bool
        inline constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x868; // BaseEntity
        inline constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x870; // float
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x874; // int
        inline constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x878; // TimeSince
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x87C; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x880; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x884; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x888; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x88C; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x890; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x894; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x898; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x8A0; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x8A8; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x8AC; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x8B0; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x8B8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x8C0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x8C8; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x8D0; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x8D8; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x8E0; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x8E8; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x8F0; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x8F8; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x900; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x908; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x910; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x918; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x920; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x924; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x928; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x930; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x938; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x94C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x960; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x974; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x988; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x990; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x994; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x998; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x99C; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x9A0; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x9A4; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x9A8; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x9AC; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x9B0; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x9B8; // BaseEntity
    } // namespace BasePlayer
