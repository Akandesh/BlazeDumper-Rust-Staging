...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2F61A88;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2FB0E10;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2FC2420;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2FA0458;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2F61CF8;
    namespace BasePlayer {
        inline constexpr ::std::ptrdiff_t __menuOption_Climb = 0x258; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Drink = 0x2C8; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_InviteToTeam = 0x338; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_AssistPlayer = 0x3A8; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x418; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Promote = 0x488; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x4F8; // Option
        inline constexpr ::std::ptrdiff_t playerModel = 0x568; // PlayerModel
        inline constexpr ::std::ptrdiff_t Frozen = 0x570; // bool
        inline constexpr ::std::ptrdiff_t voiceRecorder = 0x578; // PlayerVoiceRecorder
        inline constexpr ::std::ptrdiff_t voiceSpeaker = 0x580; // PlayerVoiceSpeaker
        inline constexpr ::std::ptrdiff_t input = 0x588; // PlayerInput
        inline constexpr ::std::ptrdiff_t movement = 0x590; // BaseMovement
        inline constexpr ::std::ptrdiff_t collision = 0x598; // BaseCollision
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x5A0; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x5A8; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x5B0; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x5B8; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x5C4; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x5C8; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x5C9; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x5CA; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x5CB; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x5CC; // uint
        inline constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x5D0; // TimeSince
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x5D4; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x5D8; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x5DC; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x5E8; // Vector3
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x5F4; // bool
        inline constexpr ::std::ptrdiff_t GestureViewModel = 0x5F8; // ViewModel
        inline constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x600; // RealTimeSince
        inline constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x604; // float
        inline constexpr ::std::ptrdiff_t usePressTime = 0x608; // float
        inline constexpr ::std::ptrdiff_t useHeldTime = 0x60C; // float
        inline constexpr ::std::ptrdiff_t lookingAtTest = 0x610; // HitTest
        inline constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x618; // Vector3
        inline constexpr ::std::ptrdiff_t gestureList = 0x628; // GestureCollection
        inline constexpr ::std::ptrdiff_t gestureFinishedTime = 0x630; // TimeUntil
        inline constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x634; // TimeSince
        inline constexpr ::std::ptrdiff_t currentGesture = 0x638; // GestureConfig
        inline constexpr ::std::ptrdiff_t disabledHeldEntity = 0x640; // HeldEntity
        inline constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x648; // float
        inline constexpr ::std::ptrdiff_t lastGestureCancel = 0x64C; // TimeSince
        inline constexpr ::std::ptrdiff_t client_lastHelloTime = 0x650; // float
        inline constexpr ::std::ptrdiff_t currentTeam = 0x658; // ulong
        inline constexpr ::std::ptrdiff_t clientTeam = 0x660; // PlayerTeam
        inline constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x668; // float
        inline constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x670; // ulong
        inline constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x678; // int
        inline constexpr ::std::ptrdiff_t playerGroupKey = 0x680; // string
        inline constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x688; // string
        inline constexpr ::std::ptrdiff_t clActiveItem = 0x690; // ItemId
        inline constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x698; // List<MapNote>
        inline constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x6A0; // MapNote
        inline constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x6A8; // bool
        inline constexpr ::std::ptrdiff_t missions = 0x6B0; // List<BaseMission.MissionInstance>
        inline constexpr ::std::ptrdiff_t _activeMission = 0x6B8; // int
        inline constexpr ::std::ptrdiff_t modelState = 0x6C0; // ModelState
        inline constexpr ::std::ptrdiff_t mounted = 0x6C8; // EntityRef
        inline constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x6D8; // float
        inline constexpr ::std::ptrdiff_t PetEntity = 0x6E0; // BaseEntity
        inline constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x6E8; // float
        inline constexpr ::std::ptrdiff_t PetPrefabID = 0x6EC; // uint
        inline constexpr ::std::ptrdiff_t PetID = 0x6F0; // NetworkableId
        inline constexpr ::std::ptrdiff_t ClientCurrentPings = 0x6F8; // List<MapNote>
        inline constexpr ::std::ptrdiff_t tapInProcess = 0x700; // bool
        inline constexpr ::std::ptrdiff_t lastPingTap = 0x704; // TimeSince
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x708; // float
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x710; // BuildingPrivlidge
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x718; // int
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x71C; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x720; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x724; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x728; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x72C; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x730; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x734; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x738; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x740; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x748; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x74C; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x750; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x758; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x760; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x768; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x770; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x778; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x780; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x788; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x790; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x798; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x7A0; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x7A8; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x7B0; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x7B8; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x7C0; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x7C4; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x7C8; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x7D0; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x7D8; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x7EC; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x800; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x814; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x828; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x830; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x834; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x838; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x83C; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x840; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x844; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x848; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x84C; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x850; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x858; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        inline constexpr ::std::ptrdiff_t repair = 0x210; // BaseCombatEntity.Repair
        inline constexpr ::std::ptrdiff_t ShowHealthInfo = 0x238; // bool
        inline constexpr ::std::ptrdiff_t lifestate = 0x23C; // BaseCombatEntity.LifeState
        inline constexpr ::std::ptrdiff_t sendsHitNotification = 0x240; // bool
        inline constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x241; // bool
        inline constexpr ::std::ptrdiff_t markAttackerHostile = 0x242; // bool
        inline constexpr ::std::ptrdiff_t _health = 0x244; // float
        inline constexpr ::std::ptrdiff_t _maxHealth = 0x248; // float
        inline constexpr ::std::ptrdiff_t faction = 0x24C; // BaseCombatEntity.Faction
        inline constexpr ::std::ptrdiff_t deathTime = 0x250; // float
        inline constexpr ::std::ptrdiff_t lastNotifyFrame = 0x254; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x430; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x4A0; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x510; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x580; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x5F0; // Option
        inline constexpr ::std::ptrdiff_t authorizedPlayers = 0x660; // List<PlayerNameID>
        inline constexpr ::std::ptrdiff_t allowedConstructionItems = 0x668; // List<ItemDefinition>
        inline constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x670; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x674; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x678; // float
    } // namespace BuildingPrivlidge
    ...
    namespace FishingBobber {
        inline constexpr ::std::ptrdiff_t centerOfMass = 0x258; // Transform
        inline constexpr ::std::ptrdiff_t myRigidBody = 0x260; // Rigidbody
        inline constexpr ::std::ptrdiff_t lineAttachPoint = 0x268; // Transform
        inline constexpr ::std::ptrdiff_t bobberRoot = 0x270; // Transform
        inline constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x278; // float
        inline constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x27C; // float
        inline constexpr ::std::ptrdiff_t SidewaysInputForce = 0x280; // float
        inline constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x284; // float
        inline constexpr ::std::ptrdiff_t fishLerp = 0x288; // float
        inline constexpr ::std::ptrdiff_t lastPosition = 0x28C; // Vector3
    } // namespace FishingBobber
