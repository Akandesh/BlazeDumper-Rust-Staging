...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x344C590;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x34A5758;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34BAE68;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x348B630;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x344C840;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x868; // int
        inline constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x86C; // TimeSince
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x870; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x874; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x878; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x87C; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x880; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x884; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x888; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x890; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x898; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x8A0; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x8A4; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x8A8; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x8B0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x8B8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x8C0; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x8C8; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x8D0; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x8D8; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x8E0; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x8E8; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x8F0; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x8F8; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x900; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x908; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x910; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x918; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x91C; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x920; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x928; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x930; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x944; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x958; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x96C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x980; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x988; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x98C; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x990; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x994; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x998; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x99C; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x9A0; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x9A4; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x9A8; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x9B0; // BaseEntity
    } // namespace BasePlayer
