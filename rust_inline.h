...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3488498;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x34E1E08;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x34F7510;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x34C7898;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x3488750;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t __menuOption_InviteToClan = 0x370; // Option
        ...
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_LootPlayer = 0x4F0; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Promote = 0x570; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_SaltWater = 0x5F0; // Option
        inline constexpr ::std::ptrdiff_t clanId = 0x670; // long
        inline constexpr ::std::ptrdiff_t playerModel = 0x678; // PlayerModel
        inline constexpr ::std::ptrdiff_t Frozen = 0x680; // bool
        inline constexpr ::std::ptrdiff_t voiceRecorder = 0x688; // PlayerVoiceRecorder
        inline constexpr ::std::ptrdiff_t voiceSpeaker = 0x690; // PlayerVoiceSpeaker
        inline constexpr ::std::ptrdiff_t input = 0x698; // PlayerInput
        inline constexpr ::std::ptrdiff_t movement = 0x6A0; // BaseMovement
        inline constexpr ::std::ptrdiff_t collision = 0x6A8; // BaseCollision
        inline constexpr ::std::ptrdiff_t bagCount = 0x6B0; // int
        inline constexpr ::std::ptrdiff_t shelterCount = 0x6B4; // int
        inline constexpr ::std::ptrdiff_t modelInitUnderwear = 0x6B8; // uint
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x6C0; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x6C8; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x6D0; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x6D8; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x6E4; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x6E8; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x6E9; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x6EA; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x6EB; // bool
        inline constexpr ::std::ptrdiff_t HasMountedClothing = 0x6EC; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x6F0; // uint
        inline constexpr ::std::ptrdiff_t lastOpenSoundPlay = 0x6F4; // TimeSince
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x6F8; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x6FC; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x700; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x70C; // Vector3
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x718; // bool
        inline constexpr ::std::ptrdiff_t GestureViewModel = 0x720; // ViewModel
        inline constexpr ::std::ptrdiff_t currentClientRespawnInformation = 0x728; // RespawnInformation
        inline constexpr ::std::ptrdiff_t respawnOptionsTimestamp = 0x730; // float
        inline constexpr ::std::ptrdiff_t lastParachuteRequest = 0x734; // TimeSince
        inline constexpr ::std::ptrdiff_t timeSinceUpdatedLookingAt = 0x738; // RealTimeSince
        inline constexpr ::std::ptrdiff_t nextTopologyTestTime = 0x73C; // float
        inline constexpr ::std::ptrdiff_t usePressTime = 0x740; // float
        inline constexpr ::std::ptrdiff_t useHeldTime = 0x744; // float
        inline constexpr ::std::ptrdiff_t lookingAtTest = 0x748; // HitTest
        inline constexpr ::std::ptrdiff_t cachedWaterDrinkingPoint = 0x750; // Vector3
        inline constexpr ::std::ptrdiff_t hasRequestedServerEmoji = 0x75C; // bool
        inline constexpr ::std::ptrdiff_t gestureList = 0x770; // GestureCollection
        inline constexpr ::std::ptrdiff_t gestureFinishedTime = 0x778; // TimeUntil
        inline constexpr ::std::ptrdiff_t blockHeldInputTimer = 0x77C; // TimeSince
        inline constexpr ::std::ptrdiff_t currentGesture = 0x780; // GestureConfig
        inline constexpr ::std::ptrdiff_t disabledHeldEntity = 0x788; // HeldEntity
        inline constexpr ::std::ptrdiff_t nextGestureMenuOpenTime = 0x790; // float
        inline constexpr ::std::ptrdiff_t lastGestureCancel = 0x794; // TimeSince
        inline constexpr ::std::ptrdiff_t client_lastHelloTime = 0x798; // float
        inline constexpr ::std::ptrdiff_t currentTeam = 0x7A0; // ulong
        inline constexpr ::std::ptrdiff_t clientTeam = 0x7A8; // PlayerTeam
        inline constexpr ::std::ptrdiff_t lastReceivedTeamTime = 0x7B0; // float
        inline constexpr ::std::ptrdiff_t lastPresenceTeamId = 0x7B8; // ulong
        inline constexpr ::std::ptrdiff_t lastPresenceTeamSize = 0x7C0; // int
        inline constexpr ::std::ptrdiff_t playerGroupKey = 0x7C8; // string
        inline constexpr ::std::ptrdiff_t playerGroupSizeKey = 0x7D0; // string
        inline constexpr ::std::ptrdiff_t clActiveItem = 0x7D8; // ItemId
        inline constexpr ::std::ptrdiff_t ClientCurrentMapNotes = 0x7E0; // List<MapNote>
        inline constexpr ::std::ptrdiff_t ClientCurrentDeathNote = 0x7E8; // MapNote
        inline constexpr ::std::ptrdiff_t keepOpenMapInterface = 0x7F0; // bool
        inline constexpr ::std::ptrdiff_t missions = 0x7F8; // List<BaseMission.MissionInstance>
        inline constexpr ::std::ptrdiff_t _activeMission = 0x800; // int
        inline constexpr ::std::ptrdiff_t modelState = 0x808; // ModelState
        inline constexpr ::std::ptrdiff_t mounted = 0x810; // EntityRef
        inline constexpr ::std::ptrdiff_t nextSeatSwapTime = 0x820; // float
        inline constexpr ::std::ptrdiff_t mountInputHeldDuringDismount = 0x824; // bool
        inline constexpr ::std::ptrdiff_t PetEntity = 0x828; // BaseEntity
        inline constexpr ::std::ptrdiff_t lastPetCommandIssuedTime = 0x830; // float
        inline constexpr ::std::ptrdiff_t PetPrefabID = 0x834; // uint
        inline constexpr ::std::ptrdiff_t PetID = 0x838; // NetworkableId
        inline constexpr ::std::ptrdiff_t ClientCurrentPings = 0x840; // List<MapNote>
        inline constexpr ::std::ptrdiff_t tapInProcess = 0x848; // bool
        inline constexpr ::std::ptrdiff_t lastPingTap = 0x84C; // TimeSince
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilegeTime = 0x850; // float
        inline constexpr ::std::ptrdiff_t cachedBuildingPrivilege = 0x858; // BuildingPrivlidge
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlockedTime = 0x860; // float
        inline constexpr ::std::ptrdiff_t cachedVehicleBuildingBlocked = 0x864; // bool
        inline constexpr ::std::ptrdiff_t cachedEntityBuildingBlockedTime = 0x868; // float
        inline constexpr ::std::ptrdiff_t cachedEntityBuildingBlocked = 0x86C; // bool
        inline constexpr ::std::ptrdiff_t cachedPrivilegeFromOther = 0x870; // BaseEntity
        inline constexpr ::std::ptrdiff_t cachedPrivilegeFromOtherTime = 0x878; // float
        inline constexpr ::std::ptrdiff_t maxProjectileID = 0x87C; // int
        inline constexpr ::std::ptrdiff_t lastSpectateCameraUpdate = 0x880; // TimeSince
        inline constexpr ::std::ptrdiff_t lastUpdateTime = 0x884; // float
        inline constexpr ::std::ptrdiff_t cachedThreatLevel = 0x888; // float
        inline constexpr ::std::ptrdiff_t serverTickRate = 0x88C; // int
        inline constexpr ::std::ptrdiff_t clientTickRate = 0x890; // int
        inline constexpr ::std::ptrdiff_t serverTickInterval = 0x894; // float
        inline constexpr ::std::ptrdiff_t clientTickInterval = 0x898; // float
        inline constexpr ::std::ptrdiff_t lastSentTickTime = 0x89C; // float
        inline constexpr ::std::ptrdiff_t lastTickStopwatch = 0x8A0; // Stopwatch
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x8A8; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x8B0; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x8B4; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x8B8; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x8C0; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x8C8; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x8D0; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x8D8; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x8E0; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x8E8; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x8F0; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x8F8; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x900; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x908; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x910; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x918; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x920; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x928; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x92C; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x930; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x938; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x940; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x954; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x968; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x97C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x990; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x998; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x99C; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x9A0; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x9A4; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x9A8; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x9AC; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x9B0; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x9B4; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x9B8; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x9C0; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseCombatEntity {
        ...
        inline constexpr ::std::ptrdiff_t ShowHealthInfo = 0x250; // bool
        inline constexpr ::std::ptrdiff_t lifestate = 0x254; // BaseCombatEntity.LifeState
        inline constexpr ::std::ptrdiff_t sendsHitNotification = 0x258; // bool
        inline constexpr ::std::ptrdiff_t sendsMeleeHitNotification = 0x259; // bool
        inline constexpr ::std::ptrdiff_t markAttackerHostile = 0x25A; // bool
        inline constexpr ::std::ptrdiff_t _health = 0x25C; // float
        inline constexpr ::std::ptrdiff_t _maxHealth = 0x260; // float
        inline constexpr ::std::ptrdiff_t faction = 0x264; // BaseCombatEntity.Faction
        inline constexpr ::std::ptrdiff_t deathTime = 0x268; // float
        inline constexpr ::std::ptrdiff_t lastNotifyFrame = 0x26C; // int
    } // namespace BaseCombatEntity
    namespace BuildingPrivlidge {
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_MaxAuth = 0x480; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_Menu_RotateVM = 0x500; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuAuthorize = 0x580; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuClearList = 0x600; // Option
        inline constexpr ::std::ptrdiff_t __menuOption_MenuDeauthorize = 0x680; // Option
        inline constexpr ::std::ptrdiff_t authorizedPlayers = 0x700; // List<PlayerNameID>
        inline constexpr ::std::ptrdiff_t allowedConstructionItems = 0x708; // List<ItemDefinition>
        inline constexpr ::std::ptrdiff_t cachedProtectedMinutes = 0x710; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepPeriodMinutes = 0x714; // float
        inline constexpr ::std::ptrdiff_t cachedUpkeepCostFraction = 0x718; // float
    } // namespace BuildingPrivlidge
    ...
    namespace FishingBobber {
        inline constexpr ::std::ptrdiff_t centerOfMass = 0x270; // Transform
        inline constexpr ::std::ptrdiff_t myRigidBody = 0x278; // Rigidbody
        inline constexpr ::std::ptrdiff_t lineAttachPoint = 0x280; // Transform
        inline constexpr ::std::ptrdiff_t bobberRoot = 0x288; // Transform
        inline constexpr ::std::ptrdiff_t HorizontalMoveSpeed = 0x290; // float
        inline constexpr ::std::ptrdiff_t PullAwayMoveSpeed = 0x294; // float
        inline constexpr ::std::ptrdiff_t SidewaysInputForce = 0x298; // float
        inline constexpr ::std::ptrdiff_t ReelInMoveSpeed = 0x29C; // float
        inline constexpr ::std::ptrdiff_t fishLerp = 0x2A0; // float
        inline constexpr ::std::ptrdiff_t lastPosition = 0x2A4; // Vector3
    } // namespace FishingBobber
