...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x2EDF7B8;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x2F2CD40;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x2F3E4D8;
    inline constexpr ::std::ptrdiff_t System_Collections_Generic_List_BaseGameMode_TypeInfo = 0x2F1D168;
    inline constexpr ::std::ptrdiff_t BaseGameMode_TypeInfo = 0x2EDFA28;
