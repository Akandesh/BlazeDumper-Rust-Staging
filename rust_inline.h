...
namespace blazedumper {
    inline constexpr ::std::ptrdiff_t BaseEntity_TypeInfo = 0x3215AC8;
    inline constexpr ::std::ptrdiff_t MainCamera_TypeInfo = 0x3217678;
    inline constexpr ::std::ptrdiff_t Facepunch_Input_TypeInfo = 0x3227DC0;
    namespace BasePlayer {
        ...
        inline constexpr ::std::ptrdiff_t currentViewMode = 0x4A8; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t selectedViewMode = 0x4AC; // BasePlayer.CameraMode
        inline constexpr ::std::ptrdiff_t lastRevivePoint = 0x4B0; // Vector3
        inline constexpr ::std::ptrdiff_t lastReviveDirection = 0x4BC; // Vector3
        inline constexpr ::std::ptrdiff_t playerModel = 0x4C8; // PlayerModel
        inline constexpr ::std::ptrdiff_t Frozen = 0x4D0; // bool
        inline constexpr ::std::ptrdiff_t voiceRecorder = 0x4D8; // PlayerVoiceRecorder
        inline constexpr ::std::ptrdiff_t voiceSpeaker = 0x4E0; // PlayerVoiceSpeaker
        inline constexpr ::std::ptrdiff_t input = 0x4E8; // PlayerInput
        inline constexpr ::std::ptrdiff_t movement = 0x4F0; // BaseMovement
        inline constexpr ::std::ptrdiff_t collision = 0x4F8; // BaseCollision
        inline constexpr ::std::ptrdiff_t _lookingAt = 0x500; // GameObject
        inline constexpr ::std::ptrdiff_t _lookingAtEntity = 0x508; // BaseEntity
        inline constexpr ::std::ptrdiff_t _lookingAtCollider = 0x510; // Collider
        inline constexpr ::std::ptrdiff_t lookingAtPoint = 0x518; // Vector3
        inline constexpr ::std::ptrdiff_t wakeTime = 0x524; // float
        inline constexpr ::std::ptrdiff_t needsClothesRebuild = 0x528; // bool
        inline constexpr ::std::ptrdiff_t wasSleeping = 0x529; // bool
        inline constexpr ::std::ptrdiff_t wokeUpBefore = 0x52A; // bool
        inline constexpr ::std::ptrdiff_t wasDead = 0x52B; // bool
        inline constexpr ::std::ptrdiff_t lastClothesHash = 0x52C; // uint
        inline constexpr ::std::ptrdiff_t IsWearingDiveGoggles = 0x530; // bool
        ...
        inline constexpr ::std::ptrdiff_t lastSentTick = 0x658; // PlayerTick
        inline constexpr ::std::ptrdiff_t nextVisThink = 0x660; // float
        inline constexpr ::std::ptrdiff_t lastTimeSeen = 0x664; // float
        inline constexpr ::std::ptrdiff_t debugPrevVisible = 0x668; // bool
        inline constexpr ::std::ptrdiff_t fallDamageEffect = 0x670; // GameObjectRef
        inline constexpr ::std::ptrdiff_t drownEffect = 0x678; // GameObjectRef
        inline constexpr ::std::ptrdiff_t playerFlags = 0x680; // BasePlayer.PlayerFlags
        inline constexpr ::std::ptrdiff_t eyes = 0x688; // PlayerEyes
        inline constexpr ::std::ptrdiff_t inventory = 0x690; // PlayerInventory
        inline constexpr ::std::ptrdiff_t blueprints = 0x698; // PlayerBlueprints
        inline constexpr ::std::ptrdiff_t metabolism = 0x6A0; // PlayerMetabolism
        inline constexpr ::std::ptrdiff_t modifiers = 0x6A8; // PlayerModifiers
        inline constexpr ::std::ptrdiff_t playerCollider = 0x6B0; // CapsuleCollider
        inline constexpr ::std::ptrdiff_t Belt = 0x6B8; // PlayerBelt
        inline constexpr ::std::ptrdiff_t playerRigidbody = 0x6C0; // Rigidbody
        inline constexpr ::std::ptrdiff_t userID = 0x6C8; // ulong
        inline constexpr ::std::ptrdiff_t UserIDString = 0x6D0; // string
        inline constexpr ::std::ptrdiff_t gamemodeteam = 0x6D8; // int
        inline constexpr ::std::ptrdiff_t reputation = 0x6DC; // int
        inline constexpr ::std::ptrdiff_t _displayName = 0x6E0; // string
        inline constexpr ::std::ptrdiff_t _lastSetName = 0x6E8; // string
        inline constexpr ::std::ptrdiff_t playerColliderStanding = 0x6F0; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderDucked = 0x704; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderCrawling = 0x718; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t playerColliderLyingDown = 0x72C; // BasePlayer.CapsuleColliderInfo
        inline constexpr ::std::ptrdiff_t cachedProtection = 0x740; // ProtectionProperties
        inline constexpr ::std::ptrdiff_t lastHeadshotSoundTime = 0x748; // float
        inline constexpr ::std::ptrdiff_t nextColliderRefreshTime = 0x74C; // float
        inline constexpr ::std::ptrdiff_t clothingBlocksAiming = 0x750; // bool
        inline constexpr ::std::ptrdiff_t clothingMoveSpeedReduction = 0x754; // float
        inline constexpr ::std::ptrdiff_t clothingWaterSpeedBonus = 0x758; // float
        inline constexpr ::std::ptrdiff_t clothingAccuracyBonus = 0x75C; // float
        inline constexpr ::std::ptrdiff_t equippingBlocked = 0x760; // bool
        inline constexpr ::std::ptrdiff_t eggVision = 0x764; // float
        inline constexpr ::std::ptrdiff_t activeTelephone = 0x768; // PhoneController
        inline constexpr ::std::ptrdiff_t designingAIEntity = 0x770; // BaseEntity
    } // namespace BasePlayer
    ...
    namespace BaseProjectile {
        ...
        inline constexpr ::std::ptrdiff_t resetDuration = 0x314; // float
        inline constexpr ::std::ptrdiff_t numShotsFired = 0x318; // int
        inline constexpr ::std::ptrdiff_t nextReloadTime = 0x31C; // float
        inline constexpr ::std::ptrdiff_t startReloadTime = 0x320; // float
        inline constexpr ::std::ptrdiff_t stancePenalty = 0x324; // float
        inline constexpr ::std::ptrdiff_t aimconePenalty = 0x328; // float
        inline constexpr ::std::ptrdiff_t isReloading = 0x32C; // bool
        inline constexpr ::std::ptrdiff_t swaySampleTime = 0x330; // float
        inline constexpr ::std::ptrdiff_t lastShotTime = 0x334; // float
        inline constexpr ::std::ptrdiff_t reloadPressTime = 0x338; // float
        inline constexpr ::std::ptrdiff_t ammoTypePreReload = 0x340; // ItemDefinition
        inline constexpr ::std::ptrdiff_t fractionalReloadDesiredCount = 0x348; // int
        inline constexpr ::std::ptrdiff_t fractionalReloadNumAdded = 0x34C; // int
        inline constexpr ::std::ptrdiff_t triggerReady = 0x350; // bool
        inline constexpr ::std::ptrdiff_t nextHeightCheckTime = 0x354; // float
        inline constexpr ::std::ptrdiff_t cachedUnderground = 0x358; // bool
        inline constexpr ::std::ptrdiff_t createdProjectiles = 0x360; // List<Projectile>
    } // namespace BaseProjectile
    namespace Magazine {
